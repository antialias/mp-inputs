...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tracking = __webpack_require__(429);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _irb = __webpack_require__(344);

	var _irb2 = _interopRequireDefault(_irb);

	var _util = __webpack_require__(343);

	var _builderSections = __webpack_require__(419);

	var _builderSections2 = _interopRequireDefault(_builderSections);

	var _section = __webpack_require__(420);

	var _clause = __webpack_require__(377);

	var _topEvents = __webpack_require__(421);

	var _topEvents2 = _interopRequireDefault(_topEvents);

	var _topProperties = __webpack_require__(423);

	var _topProperties2 = _interopRequireDefault(_topProperties);

	var _topPropertyValues = __webpack_require__(424);

	var _topPropertyValues2 = _interopRequireDefault(_topPropertyValues);

	var _segmentation = __webpack_require__(425);

	var _segmentation2 = _interopRequireDefault(_segmentation);

	var _queryCache = __webpack_require__(426);
	...
	var INITIAL_STATE = {
	  ...
	  sections: new _builderSections2.default({
	    ...
	    time: new _section.TimeSection(new _clause.TimeClause())
	  }),
	  editingClause: null,
	  topEvents: [],
	  topProperties: [],
	...
	var IRBApp = function (_BaseApp) {
	  ...
	  _createClass(IRBApp, [{
	    ...
	    value: function isEditingClause(sectionType, clauseIndex) {
	      return this.state.editingClause && this.state.editingClause.TYPE === sectionType && this.editingClauseIndex === clauseIndex;
	    }
	    ...
	    value: function startAddingClause(sectionType) {
	      this.update({ editingClause: _clause.Clause.create(sectionType) });
	    }
	  }, {
	    ...
	    value: function stopEditingClause() {
	      ...
	      var newState = { editingClause: null };
	      var cachedQueryResult = this.query(this.state);
	    ...
	    key: 'updateEditingClause',
	    value: function updateEditingClause(clauseData) {
	      var sectionType = this.state.editingClause.TYPE;
	      var clauseIndex = this.state.sections[sectionType].clauses.indexOf(this.state.editingClause);

	      if (clauseIndex >= 0) {
	        this.updateClause(sectionType, clauseIndex, clauseData);
	      } else {
	        this.update({ editingClause: _clause.Clause.create(sectionType, (0, _util.extend)(this.state.editingClause.attrs, clauseData)) });
	      }
	    }
	  }, {
	    key: 'updateClause',
	    value: function updateClause(sectionType, clauseIndex, clauseData, closePane) {
	      var _this2 = this;

	      var section = this.state.sections[sectionType];
	      var clause = section.clauses[clauseIndex];
	      var editingExistingClause = !!clause;

	      var oldClause = clause || this.state.editingClause;
	      var newClause = _clause.Clause.create(sectionType, (0, _util.extend)(oldClause ? oldClause.attrs : {}, clauseData));
	      var newSection = editingExistingClause ? section.replaceClause(clauseIndex, newClause) : section.addClause(newClause);
	      var newState = (0, _util.extend)(this.state, { editingClause: newClause });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _result = __webpack_require__(411);

	var _result2 = _interopRequireDefault(_result);

	var _irb = __webpack_require__(416);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _group = __webpack_require__(388);
	...
	var _builder = __webpack_require__(408);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _paneContent = __webpack_require__(376);
	...
	var _show = __webpack_require__(378);

	var _show2 = _interopRequireDefault(_show);

	var _showPaneContent = __webpack_require__(379);
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(ShowEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel(clauseIndex) {
	          ...
	          return [math, ' of ', (0, _util.renameEvent)(clause.value)];
	        }
	      });
	    }
	  }]);
	...
	var PaneView = function (_BaseView) {
	  ...
	  _createClass(PaneView, [{
	    ...
	    get: function get() {
	      ...
	      return {
	        updateClause: function updateClause(clauseIndex, data) {
	          return _this2.app.updateClause(_this2.section, clauseIndex, data);
	        }
	      };
	    }
	  }]);
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = function (Boolean, constants, elementClass, helpers, state, util, views) {
	    ...
	    jade_mixins['pane'] = function (paneViews, paneIndex) {
	      ...
	      return function () {
	        var __jade_nodes = [];
	        var paneConstants = constants.panes ? constants.panes[paneIndex] : {};;
	        ...
	        __jade_nodes.push(header ? h("div", {
	          ...
	          __jade_nodes.push(paneIndex ? h("button", {
	            ...
	            "ev-click": function evClick() {
	              return helpers.updateClause(state.clauseIndex, {
	        ...
	        __jade_nodes.push(views.panes ? function () {
	          ...
	          __jade_nodes.push(views.panes.map(function (paneViews, paneIndex) {
	            return h("div", {
	              ...
	              "style": {
	                '-webkit-transform': 'translateX(' + (paneIndex - activeIndex) * 400 + 'px)',
	    ...
	    get: function get() {
	      ...
	      return {
	        matchesSearch: function matchesSearch(value) {
	          return _this2.app.state.editingClause && (!_this2.app.state.editingClause.search || value.toLowerCase().indexOf(_this2.app.state.editingClause.search.toLowerCase()) === 0);
	        },
	        updateClause: function updateClause(clauseIndex, data, closePane) {
	          return _this2.app.updateClause(_this2.section, clauseIndex, data, closePane);
	        }
	      };
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TimeClause = exports.FilterClause = exports.GroupClause = exports.ShowClause = exports.EventsPropertiesClause = exports.Clause = undefined;
	...
	var FilterClause = exports.FilterClause = function (_EventsPropertiesClau3) {
	  ...
	  function FilterClause() {
	    ...
	    var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(FilterClause).apply(this, arguments));

	    _this4.filterType = attrs.filterType || FilterClause.FILTER_TYPES[0];

	    var filterOperatorChoices = FilterClause.FILTER_OPERATORS[_this4.filterType];
	    if (filterOperatorChoices.indexOf(attrs.filterOperator) !== -1) {
	      _this4.filterOperator = attrs.filterOperator;
	    } else {
	      _this4.filterOperator = filterOperatorChoices[0];
	    }

	    _this4.filterValue = attrs.filterValue || null;
	    _this4.filterSearch = attrs.filterSearch || null;
	    _this4.filterDateUnit = attrs.filterDateUnit || FilterClause.FILTER_DATE_UNITS[0];

	    _this4.editing = attrs.editing || null;
	    return _this4;
	  }
	...
	FilterClause.FILTER_DATE_UNITS = FilterClause.prototype.FILTER_DATE_UNITS = ['days', 'weeks', 'months', 'years'];
	...
	var TimeClause = exports.TimeClause = function (_Clause2) {
	  ...
	  function TimeClause() {
	    ...
	    var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(TimeClause).apply(this, arguments));

	    var to = new Date();
	    var from = new Date();
	    from.setHours(to.getHours() - 96);

	    _this5.unit = attrs.unit || 'hour';
	    _this5.from = attrs.from || from;
	    _this5.to = attrs.to || to;
	    return _this5;
	  }
	  ...
	  _createClass(TimeClause, [{
	    ...
	    get: function get() {
	      ...
	      return { unit: unit, from: from, to: to };
	    }
	  }, {
	    key: 'valid',
	    get: function get() {
	      return this.UNIT_TYPES.indexOf(this.unit) !== -1 && this.to instanceof Date && this.from instanceof Date;
	    }
	  }]);
	...
	TimeClause.UNIT_TYPES = TimeClause.prototype.UNIT_TYPES = ['hour', 'day', 'week', 'month', 'quarter', 'year'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = function (Boolean, constants, elementClass, helpers, state, util) {
	    var h = __webpack_require__(348);
	    var selectedMathIndex = state.editingClause && constants.mathChoices.indexOf(state.editingClause.math);
	    var selectedTypeIndex = state.editingClause && constants.resourceTypeChoices.indexOf(state.editingClause.resourceType);
	    var selectedValueIndex = state.editingClause && constants.eventChoices.indexOf(state.editingClause.value);
	    return {
	      value: h("div", {
	        "className": [elementClass].filter(Boolean).join(' ')
	      }, [[h("ul", {
	        ...
	        return h("li", {
	          "className": [selectedMathIndex === i ? 'selected' : '', math === 'sum' || math === 'median' ? 'disabled' : ''].filter(Boolean).join(' '),
	          "ev-click": function evClick() {
	            return helpers.updateClause(state.clauseIndex, {
	              math: math
	            });
	      ...
	      }, [constants.resourceTypeChoices.map(function (resourceType, i) {
	        return h("li", {
	          "className": [selectedTypeIndex === i ? 'selected' : '', resourceType !== 'all' ? 'disabled' : ''].filter(Boolean).join(' '),
	          "ev-click": function evClick() {
	            return helpers.updateClause(state.clauseIndex, {
	      ...
	      }, [constants.eventChoices.map(function (value, i) {
	        return function () {
	          var __jade_nodes = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _timePaneContent = __webpack_require__(385);
	  ...
	  _createClass(TimePaneContentView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(TimePaneContentView.prototype), 'templateHelpers', this), {
	        updateClause: function updateClause(data) {
	          return _this2.app.updateClause('time', 0, data);
	        },
	        rangeToString: function rangeToString() {
	          var _app$state$sections$g = _this2.app.state.sections.getClause('time', 0);

	          var from = _app$state$sections$g.from;
	          var to = _app$state$sections$g.to;

	          return JSON.stringify({ from: from, to: to });
	        }
	      });
	    }
	  }]);
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(TimeEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel() {
	          var _app$state$sections$g2 = _this5.app.state.sections.getClause('time', 0);

	          var unit = _app$state$sections$g2.unit;
	          var from = _app$state$sections$g2.from;
	          var to = _app$state$sections$g2.to;
	    ...
	    return {
	      value: h("div", {
	        ...
	        "ev-change": function evChange(event) {
	          return helpers.updateClause(event.target.value);
	        }
	      })])
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _propertyPaneContent = __webpack_require__(390);
	  ...
	  _createClass(GroupPaneContentView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(GroupPaneContentView.prototype), 'templateHelpers', this), {
	        selectProperty: function selectProperty(clauseIndex, property, closePane) {
	          _this2.templateHelpers.updateClause(clauseIndex, {
	            value: property.name
	          }, closePane);
	        }
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = function (Boolean, constants, elementClass, helpers, state, util) {
	    var h = __webpack_require__(348);
	    var selectedTypeIndex = state.editingClause && constants.resourceTypeChoices.indexOf(state.editingClause.resourceType);
	    var selectedValueIndex = state.editingClause && state.topProperties.indexOf(state.editingClause.value);
	    return {
	      value: h("div", {
	        ...
	        "className": ['column', 'resource-value'].filter(Boolean).join(' ')
	      }, [state.topProperties.map(function (property, i) {
	        return function () {
	          var __jade_nodes = [];
	          __jade_nodes.push(helpers.matchesSearch(util.renameProperty(property.name)) ? h("li", {
	            "className": ['property', "type-" + property.type, selectedValueIndex === i ? 'selected' : ''].filter(Boolean).join(' '),
	            "ev-click": function evClick() {
	              return helpers.selectProperty(state.clauseIndex, property, true);
	            }
	          }, [h("span", util.renameProperty(property.name)), h("button", {
	            "className": ['next-arrow'].filter(Boolean).join(' '),
	            "ev-click": function evClick() {
	              return helpers.selectProperty(state.clauseIndex, property);
	            }
	          }, ["›"])]) : undefined);;
	          return __jade_nodes;
	        }.call(this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _toggle = __webpack_require__(398);
	...
	var _propertyValuePaneContent = __webpack_require__(403);
	...
	var OperatorDropdownView = function (_DropdownView) {
	  ...
	  _createClass(OperatorDropdownView, [{
	    ...
	    key: 'choices',
	    get: function get() {
	      return _clause.FilterClause.FILTER_OPERATORS[this.app.state.editingClause.filterType];
	    }
	  }, {
	    key: 'selected',
	    get: function get() {
	...
	var OperatorToggleView = function (_ToggleView) {
	  ...
	  _createClass(OperatorToggleView, [{
	    key: 'select',
	    value: function select(filterOperator) {
	      this.app.updateEditingClause({ filterOperator: filterOperator });
	    }
	  }, {
	    key: 'choices',
	    get: function get() {
	...
	var DateUnitDropdownView = function (_DropdownView2) {
	  ...
	  _createClass(DateUnitDropdownView, [{
	    ...
	    key: 'choices',
	    get: function get() {
	      return _clause.FilterClause.FILTER_DATE_UNITS;
	    }
	  }, {
	    key: 'selected',
	    get: function get() {
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(FilterPropertyPaneContentView.prototype), 'templateHelpers', this), {
	        selectProperty: function selectProperty(clauseIndex, property, closePane) {
	          ...
	          _this5.templateHelpers.updateClause(clauseIndex, {
	            value: property.name,
	          ...
	          if (!closePane) {
	            ...
	            window.requestAnimationFrame(function () {
	              return _get(Object.getPrototypeOf(FilterPropertyPaneContentView.prototype), 'templateHelpers', _this5).updateClause(_this5.app.editingClauseIndex, { paneIndex: 1 });
	            });
	          }
	        }
	      });
	  ...
	  _createClass(FilterPropertyValuePaneContentView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(FilterPropertyValuePaneContentView.prototype), 'templateHelpers', this), {
	        updateClause: function updateClause(clauseData) {
	          return _this7.app.updateEditingClause(clauseData);
	        },
	        showPropertyValues: function showPropertyValues() {
	          return _this7.app.state.editingClause && !_this7.app.state.editingClause.filterOperatorIsSetOrNotSet;
	        },
	        ...
	        toggleStringEqualsValueSelected: function toggleStringEqualsValueSelected(value) {
	          var selected = _this7.app.state.editingClause.filterValue || [];
	          ...
	          _this7.app.updateEditingClause({ filterValue: filterValue });
	        },
	...
	var FilterPaneView = function (_PaneView) {
	  ...
	  _createClass(FilterPaneView, [{
	    ...
	    value: function getPaneIndex(clauseIndex) {
	      var clause = this.app.state.sections.getClause('filter', clauseIndex) || this.app.state.editingClause;
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(FilterPaneView.prototype), 'templateHelpers', this), {
	        getHeader: function getHeader(paneIndex) {
	          var clause = _this9.app.state.editingClause;

	          if (paneIndex && clause && clause.value) {
	            return (0, _util.renameProperty)(clause.value);
	          }

	          return 'Properties';
	        },
	        getPaneIndex: function getPaneIndex(clauseIndex) {
	          return _this9.getPaneIndex(clauseIndex);
	        }
	      });
	    }
	  }]);
	  ...
	  _createClass(FilterEditControlView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(FilterEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel(clauseIndex) {
	          var clause = _this12.app.state.sections.getClause('filter', clauseIndex);
	      ...
	      value: h("div", {
	        ...
	        __jade_nodes.push(!state.sections.filter.clauses.length ? h("div", {
	          ...
	          return [h("div", {
	            ...
	            __jade_nodes.push(clauseIndex == state.sections.filter.clauses.length - 1 ? h("div", {
	              "className": ['control-container'].filter(Boolean).join(' ')
	            }, views.addControl(state)) : undefined);;
	            return __jade_nodes;
	          }.call(this)])];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = function (Boolean, Date, JSON, Number, constants, elementClass, helpers, state, util, views) {
	    var h = __webpack_require__(348);
	    var filterProperty = state.editingClause && state.editingClause.value;
	    var filterType = state.editingClause && state.editingClause.filterType;
	    var filterOperator = state.editingClause && state.editingClause.filterOperator;
	    var filterValue = state.editingClause && state.editingClause.filterValue;
	    var filterDateUnit = state.editingClause && state.editingClause.filterDateUnit;
	    return {
	      value: h("div", {
	        "className": ['pane-content-view', elementClass, filterType ? "filter-type-" + filterType : ''].filter(Boolean).join(' ')
	      }, [function () {
	        var __jade_nodes = [];
	        __jade_nodes.push(h("table", {
	          ...
	          return h("td", {
	            "className": ['type-' + typeChoice, typeChoice === filterType ? 'selected' : ''].filter(Boolean).join(' ')
	          }, [h("button", {
	            "ev-click": function evClick() {
	              return helpers.updateClause({
	        ...
	        __jade_nodes.push(filterType ? function () {
	          var __jade_nodes = []; /*  "operator" input - present on all panes */
	          __jade_nodes.push("");
	          __jade_nodes.push(filterType === 'boolean' || filterType === 'list' ? h("div", {
	            "className": ['filter-operator-input'].filter(Boolean).join(' ')
	          }, views.operatorToggle()) : h("div", {
	            "className": ['filter-operator-input'].filter(Boolean).join(' ')
	          }, views.operatorDropdown())); /*  type-specific inputs */
	          __jade_nodes.push("");
	          __jade_nodes.push(filterType === 'string' ? function () {
	            var __jade_nodes = [];
	            __jade_nodes.push(filterOperator === 'equals' || filterOperator === 'does not equal' ? function () {
	              var __jade_nodes = [];
	              __jade_nodes.push(filterValue && filterValue.length ? h("div", {
	                "className": ['filter-string-equals-summary'].filter(Boolean).join(' ')
	              }, filterValue.length + " selected") : undefined);
	              __jade_nodes.push(h("div", {
	              ...
	              }, [helpers.getValueMatches(state.editingClause.filterSearch).map(function (value, $index) {
	                return h("li", {
	                  "className": [filterValue && filterValue.indexOf(value) !== -1 ? 'selected' : ''].filter(Boolean).join(' ')
	                }, [h("button", {
	                  "ev-click": function evClick() {
	              ...
	              return __jade_nodes;
	            }.call(this) : filterOperator === 'contains' || filterOperator === 'does not contain' ? h("div", {
	              ...
	              __jade_nodes.push(filterValue ? h("ul", {
	                "className": ['filter-string-contains-matches'].filter(Boolean).join(' ')
	              }, [helpers.getValueMatches(filterValue, filterOperator === 'does not contain').map(function (value, $index) {
	                return h("li", value);
	              })]) : undefined);;
	              return __jade_nodes;
	            }.call(this)]) : undefined);;
	            return __jade_nodes;
	          }.call(this) : filterType === 'number' ? function () {
	            var __jade_nodes = [];
	            __jade_nodes.push(filterOperator === 'is between' ? function () {
	              var __jade_nodes = [];
	              var betweenStart = filterValue ? filterValue[0] : null;;
	              var betweenEnd = filterValue ? filterValue[1] : null;;
	              __jade_nodes.push(h("div", {
	            ...
	            return __jade_nodes;
	          }.call(this) : filterType === 'datetime' ? function () {
	            var __jade_nodes = [];
	            __jade_nodes.push(filterOperator === 'was between' || filterOperator === 'was on' ? function () {
	              var __jade_nodes = [];
	              var from = filterValue ? filterValue[0] : null;;
	              var to = filterValue ? filterValue[1] : null;;
	              __jade_nodes.push(h("div", {
	                "className": ['filter-value-input'].filter(Boolean).join(' ')
	              }, [h("irb-date-picker", {
	            ...
	            }, views.dateUnitDropdown()), h("div", {
	              "className": ['connector'].filter(Boolean).join(' ')
	            }, ["ago"])]));;
	            return __jade_nodes;
	          }.call(this) : filterType === 'list' ? h("div", {
	            "className": ['filter-value-input'].filter(Boolean).join(' ')
	          }, [h("input", {
	            "type": 'text',
	            "value": filterValue,
	        ...
	        __jade_nodes.push(h("button", {
	          "className": ['filter-done'].filter(Boolean).join(' '),
	          "ev-click": function evClick() {
	            return helpers.stopEditingClause();
	          }
	        }, helpers.getDoneLabel()));;
	        return __jade_nodes;
	      }.call(this)])
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _result = __webpack_require__(413);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Section.create = Section.prototype.create = function (sectionType, attrs) {
	  switch (sectionType) {
	    case 'show':
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _base = __webpack_require__(422);
	  ...
	  _createClass(BaseQuery, [{
	    ...
	    value: function run() {
	      ...
	      return new Promise(function (resolve, reject) {
	        _this.executeQuery(query).done(function (rawResults) {
	    ...
	    key: 'buildParams',
	    value: function buildParams(query) {
	      return {};
	    }
	  }, {
	    key: 'executeQuery',
...
/***/ function(module, exports, __webpack_require__) {
	...
	function isFilterValid(property, type, operator, value, dateUnit) {
	  ...
	  var isSetOrBoolean = ['is set', 'is not set', 'is true', 'is false'].indexOf(operator) !== -1;
	  var isBetween = ['is between', 'was between'].indexOf(operator) !== -1;
	  var isDaysAgo = type === 'datetime' && ['was more than', 'was less than'].indexOf(operator) !== -1;
	  ...
	  if (isBetween && (!value || value.length !== 2 || !value[0] || !value[1])) {
	    return false;
	  }
	...
	function filterToArbSelectorString(property, type, operator, value, dateUnit) {
	  ...
	  switch (type) {
	    ...
	    case 'datetime':
	      ...
	      switch (operator) {
	        case 'was less than':
	          return '(' + property + ' > datetime(' + new Date(new Date().getTime() - value * unitMs).getTime() + '))';
	        case 'was more than':
	          return '(' + property + ' < datetime(' + new Date(new Date().getTime() - value * unitMs).getTime() + '))';
	        ...
	        case 'was between':
	          ...
	          var to = new Date(value[1].getTime());
	...
	var SegmentationQuery = function (_BaseQuery) {
	  ...
	  _createClass(SegmentationQuery, [{
	    ...
	    value: function buildQuery(state) {
	      ...
	      if (events.indexOf(_clause.ShowClause.TOP_EVENTS) !== -1) {
	      ...
	      var filters = state.sections.filter.clauses.map(function (clause) {
	        return [clause.value, clause.filterType, clause.filterOperator, clause.filterValue, clause.filterDateUnit];
	      });
	    ...
	    value: function buildParams(query) {
	      ...
	      var params = { unit: unit, from: from, to: to, type: type, event: events };
	      ...
	      var validFilters = filters.filter(function (filter) {
	        return isFilterValid.apply(undefined, _toConsumableArray(filter));
	      });

	      if (validFilters.length) {
	        params.where = validFilters.map(function (filter) {
	          return filterToArbSelectorString.apply(undefined, _toConsumableArray(filter));
	        }).join(' and ');
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mixpanelBrowser = __webpack_require__(430);

	var _mixpanelBrowser2 = _interopRequireDefault(_mixpanelBrowser);

	var _rollbarBrowser = __webpack_require__(431);
