	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(ShowEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel(index) {
	          var comparison = _this5.app.clauseAt(_constants.SECTION_SHOW, index);
	    ...
	    get: function get() {
	      ...
	      return {
	        updateSearch: function updateSearch(index, search) {
	          return _this2.app.updateSection(_this2.section, index, { search: search });
	        }
	      };
	    }
	  }]);
	      ...
	      value: h("div", {
	        ...
	        __jade_nodes.push(constants.search ? h("div", {
	          ...
	          "ev-input": function evInput(event) {
	            return helpers.updateSearch(state.index, event.target.value);
	          }
	        })]) : undefined);
	    ...
	    get: function get() {
	      ...
	      return {
	        ...
	        updateSection: function updateSection(index, data) {
	          return _this2.app.updateSection(_this2.section, index, data);
	        }
	      };
	    }
	  }]);
	  ...
	  _createClass(GroupEditControlView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(GroupEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel(index) {
	          return (0, _util.renameProperty)(_this5.app.clauseAt(_constants.SECTION_GROUP, index).value);
	        }
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilterPaneContentView = function (_PaneContentView) {
	  ...
	  _createClass(FilterPaneContentView, [{
	    ...
	    key: 'templateConstants',
	    get: function get() {
	      return (0, _util.extend)(_get(Object.getPrototypeOf(FilterPaneContentView.prototype), 'templateConstants', this), {
	        resourceTypeChoices: Object.values(_constants.RESOURCE_TYPES)
	      });
	    }
	  }]);
	  ...
	  _createClass(FilterEditControlView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(FilterEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel(index) {
	          return (0, _util.renameProperty)(_this5.app.clauseAt(_constants.SECTION_FILTER, index).value);
	        }
	      });
	    }
	  }]);
