...
/***/ function(module, exports, __webpack_require__) {
	...
	function renameProperty(property) {
	  ...
	  if (property && property.length > 1 && property[0] === '$') {
	    ...
	    return [capitalize(parts[0])].concat(_toConsumableArray(parts.slice(1))).join(' ');
	  }
	            ...
	            __jade_nodes.push(cell ? function () {
	              ...
	              __jade_nodes.push(i + 1 < row.length ? h("td", {
	                ...
	                __jade_nodes.push(Array.isArray(cell) ? h("ul", [cell.map(function (value, $index) {
	                  return h("li", util.renamePropertyValue(value.toString()));
	                })]) : h("span", util.renamePropertyValue(cell)));;
	                return __jade_nodes;
	              }.call(this)]) : h("td", {
