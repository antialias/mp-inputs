...
/***/ function(module, exports, __webpack_require__) {
	...
	var _builderSections = __webpack_require__(436);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _irb = __webpack_require__(433);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _table = __webpack_require__(420);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bar = __webpack_require__(413);
	...
	document.registerElement('irb-bar-chart-header', function (_HTMLElement) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function render() {
	      ...
	      var $ticks = $(ticks.map(function (tick) {
	        return $('<div>').addClass('bar-chart-tick').width(tickDistance / _this2._chartMax * 100 + '%').append($('<div>').addClass('text').html(tick)).get(0);
	      }));
	    ...
	    value: function format(state) {
	      ...
	      (function getRows(data) {
	        ...
	        if (containsObjects(data)) {
	          ...
	          var _keys = Object.keys(data).sort(function (a, b) {
	          ...
	          rows.push([].concat(_toConsumableArray(row), [_keys, values]));
	        }
	      })(data);

	      rows = transpose(rows);
	      rows = rows.map(function (row) {
	        return row.map(function (key, i) {
	          return (// ['a', 'a', 'a', 'b', 'b'] -> ['a', null, null, 'b', null]
	      ...
	      var rowSpans = levels.map(function (level, i) {
	        return levels.slice(i + 1).reduce(function (accum, level) {
	          return accum * level.length;
	        }, 1);
	      });

	      return { headers: headers, levels: levels, rows: rows, rowSpans: rowSpans, chartMax: chartMax };
	    }
	  }, {
	    key: 'TEMPLATE',
	    get: function get() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function (Array, Boolean, JSON, Math, elementClass, state, util) {
	    var h = __webpack_require__(348);
	    var gridLineDistance = util.getTickDistance(state.chartMax);
	        ...
	        return h("tr", [row.map(function (cell, i) {
	          return function () {
	            ...
	            __jade_nodes.push(cell ? function () {
	              ...
	              })]), h("ul", [cell.map(function (value, i) {
	                return h("li", {
	                  "className": ['chart-bar', value / state.chartMax < .03 ? 'narrow' : ''].filter(Boolean).join(' '),
	                  "style": {
	  ...
	  }.call(this, "Array" in locals ? locals.Array : typeof Array !== "undefined" ? Array : undefined, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "JSON" in locals ? locals.JSON : typeof JSON !== "undefined" ? JSON : undefined, "Math" in locals ? locals.Math : typeof Math !== "undefined" ? Math : undefined, "elementClass" in locals ? locals.elementClass : typeof elementClass !== "undefined" ? elementClass : undefined, "state" in locals ? locals.state : typeof state !== "undefined" ? state : undefined, "util" in locals ? locals.util : typeof util !== "undefined" ? util : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	document.registerElement('irb-line-chart', function (_HTMLElement) {
	  _inherits(_class, _HTMLElement);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _base = __webpack_require__(439);
...
/***/ function(module, exports) {
	...
	var BaseQuery = function () {
	  ...
	  _createClass(BaseQuery, [{
	      ...
	      return new Promise(function (resolve, reject) {
	        _this.executeQuery(query).done(function (rawResults) {
	          if (query === _this.query) {
	            ...
	            resolve(_this.processResults(rawResults, query));
	          }
	        });
	      });
	    }
	    ...
	    key: 'processResults',
	    value: function processResults(results, query) {
	      return results;
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function filterToArbSelectorString(property, type, operator, value, dateUnit) {
	  ...
	  switch (type) {
	    ...
	    case 'datetime':
	      var unitMs = MS_BY_UNIT[dateUnit];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mixpanelBrowser = __webpack_require__(447);

	var _mixpanelBrowser2 = _interopRequireDefault(_mixpanelBrowser);

	var _rollbarBrowser = __webpack_require__(448);
