...
/***/ function(module, exports, __webpack_require__) {
	...
	var _framesg = __webpack_require__(292);
	...
	var _tracking = __webpack_require__(407);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baseApp = __webpack_require__(294);

	var _baseApp2 = _interopRequireDefault(_baseApp);

	var _irb = __webpack_require__(343);
	  ...
	  switch (section) {
	    ...
	    case _constants.SECTION_FILTER:
	      return (0, _util.extend)({
	        ...
	        type: _constants.RESOURCE_EVENTS,
	        value: null,
	        filterType: _constants.FILTER_EQUALS,
	        filterValue: null,
	        paneIndex: 0,
	        search: ''
	      }, data);
	...
	}, _defineProperty(_INITIAL_STATE, _constants.SECTION_SHOW, [createNewClause(_constants.SECTION_SHOW, { value: _constants.RESOURCE_VALUE_TOP_EVENTS })]), _defineProperty(_INITIAL_STATE, _constants.SECTION_TIME, [createNewClause(_constants.SECTION_TIME)]), _defineProperty(_INITIAL_STATE, _constants.SECTION_GROUP, []), _defineProperty(_INITIAL_STATE, _constants.SECTION_FILTER, []), _defineProperty(_INITIAL_STATE, 'topEvents', []), _defineProperty(_INITIAL_STATE, 'topProperties', []), _defineProperty(_INITIAL_STATE, 'topPropertyValues', {}), _defineProperty(_INITIAL_STATE, 'query', {}), _defineProperty(_INITIAL_STATE, 'result', {}), _INITIAL_STATE);
	...
	var IRBApp = function (_BaseApp) {
	  ...
	  function IRBApp(elID) {
	    ...
	    window.MP.api.topEvents().done(function (results) {
	      return _this.update({ topEvents: [_constants.RESOURCE_VALUE_TOP_EVENTS].concat(_toConsumableArray(Object.values(results.values()))) });
	    });

	    window.MP.api.topProperties().done(function (results) {
	      var props = results.values();
	      _this.update({ topProperties: Object.keys(props).sort(function (a, b) {
	  ...
	  _createClass(IRBApp, [{
	    ...
	    value: function updateSection(sectionType, index, clauseData) {
	      ...
	      clauseData.filterType === _constants.FILTER_SET || clauseData.filterType === _constants.FILTER_NOT_SET) {
	      ...
	      if (this.isClauseValid(newClause)) {
	        ...
	        if (clause) {
	          ...
	          newClause.section === _constants.SECTION_FILTER && clauseData.filterType === _constants.FILTER_SET || clauseData.filterType === _constants.FILTER_NOT_SET || newClause.value && !clause.filterValue && clauseData.filterValue) {
	            newState.editing = null;
	          }
	        } else {
	          newSection = [].concat(_toConsumableArray(section), [newClause]);

	          // don't keep the pane open if we're adding a new non-filter clause
	          if (newClause.section !== _constants.SECTION_FILTER) {
	            newState.editing = null;
	          }
	        }
	    ...
	    key: 'updatePaneIndex',
	    value: function updatePaneIndex(sectionType, paneIndex) {
	      this.updateSection(sectionType, this.state[sectionType].indexOf(this.state.editing), { paneIndex: paneIndex });
	    }
	  }, {
	    key: 'removeClause',
	    ...
	    value: function query() {
	      ...
	      var query = {
	        ...
	        filters: this.state[_constants.SECTION_FILTER].map(function (clause) {
	          return [clause.value, clause.filterType, clause.filterValue];
	        }),
	        unit: time.unit,
	      ...
	      if (query.events.indexOf(_constants.RESOURCE_VALUE_TOP_EVENTS) !== -1) {
	        query.events = (0, _util.removeAtIndex)(this.state.topEvents, this.state.topEvents.indexOf(_constants.RESOURCE_VALUE_TOP_EVENTS));
	      }

	      var matchesState = function matchesState(key) {
	        ...
	        if (events.length) {
	          ...
	          if (filters.length) {
	            (function () {
	              ...
	              params.where = filters.map(function (filter) {
	                var _filter = _slicedToArray(filter, 3);

	                var property = _filter[0];
	                var type = _filter[1];
	                var value = _filter[2];

	                var isValid = !!(property && (value || type === _constants.FILTER_SET || type === _constants.FILTER_NOT_SET));
	                ...
	                switch (type) {
	                  case _constants.FILTER_EQUALS:
	                    return format(property, '==', value);
	                  case _constants.FILTER_NOT_EQUALS:
	                    return format(property, '!=', value);
	                  case _constants.FILTER_CONTAINS:
	                    return format(value, 'in', property);
	                  case _constants.FILTER_NOT_CONTAINS:
	                    return format('not', value, 'in', property);
	                  case _constants.FILTER_SET:
	                    return format('defined', property);
	                  case _constants.FILTER_NOT_SET:
	                    return format('not defined', property);
	                }
	    ...
	    value: function queryPropertyValues() {
	      var _this3 = this;

	      if (this.state.editing && this.state.editing.section === _constants.SECTION_FILTER) {
	        (function () {
	          var name = _this3.state.editing.value;

	          if (name && !_this3.state.topPropertyValues[name]) {
	            window.MP.api.query('api/2.0/events/properties/values', { name: name }).done(function (results) {
	              return _this3.update({
	                topPropertyValues: (0, _util.extend)(_this3.state.topPropertyValues, _defineProperty({}, name, results.sort()))
	              });
	            });
	          }
	        })();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parentFrame = __webpack_require__(342);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createElement = __webpack_require__(297);
	...
	var _patch = __webpack_require__(315);

	var _patch2 = _interopRequireDefault(_patch);

	var _domDelegator = __webpack_require__(320);

	var _domDelegator2 = _interopRequireDefault(_domDelegator);

	var _mainLoop = __webpack_require__(333);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createElement = __webpack_require__(298)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var document = __webpack_require__(299)

	var applyProperties = __webpack_require__(301)

	var isVNode = __webpack_require__(304)
	var isVText = __webpack_require__(306)
	var isWidget = __webpack_require__(307)
	var handleThunk = __webpack_require__(308)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var minDoc = __webpack_require__(300);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHook = __webpack_require__(303)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isVText = __webpack_require__(306)
	var isWidget = __webpack_require__(307)
	var isThunk = __webpack_require__(309)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var diff = __webpack_require__(311)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VPatch = __webpack_require__(313)
	var isVNode = __webpack_require__(304)
	var isVText = __webpack_require__(306)
	var isWidget = __webpack_require__(307)
	var isThunk = __webpack_require__(309)
	...
	var diffProps = __webpack_require__(314)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var patch = __webpack_require__(316)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var render = __webpack_require__(298)
	var domIndex = __webpack_require__(317)
	var patchOp = __webpack_require__(318)
	module.exports = patch
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateWidget = __webpack_require__(319)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cuid = __webpack_require__(322)
	var globalDocument = __webpack_require__(299)

	var DOMDelegator = __webpack_require__(323)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var globalDocument = __webpack_require__(299)
	var EvStore = __webpack_require__(324)
	var createStore = __webpack_require__(327)

	var addEvent = __webpack_require__(329)
	var removeEvent = __webpack_require__(330)
	var ProxyEvent = __webpack_require__(331)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OneVersionConstraint = __webpack_require__(325);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Individual = __webpack_require__(326);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hiddenStore = __webpack_require__(328);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var raf = __webpack_require__(334)
	var TypedError = __webpack_require__(336)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var now = __webpack_require__(335)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var camelize = __webpack_require__(337)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _builder = __webpack_require__(361);
	...
	var _irb = __webpack_require__(402);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autoSizingInput = __webpack_require__(360);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VText = __webpack_require__(351);
	var isVNode = __webpack_require__(304);
	var isVText = __webpack_require__(306);
	var isWidget = __webpack_require__(307);
	var isHook = __webpack_require__(303);
	var isVThunk = __webpack_require__(309);

	var parseTag = __webpack_require__(352);
	var softSetHook = __webpack_require__(354);
	var evHook = __webpack_require__(355);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isWidget = __webpack_require__(307)
	var isThunk = __webpack_require__(309)
	var isVHook = __webpack_require__(303)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var split = __webpack_require__(353);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _show = __webpack_require__(362);

	var _show2 = _interopRequireDefault(_show);

	var _time = __webpack_require__(377);

	var _time2 = _interopRequireDefault(_time);

	var _group = __webpack_require__(383);
	...
	var _builder = __webpack_require__(394);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _control = __webpack_require__(363);

	var _pane = __webpack_require__(367);

	var _pane2 = _interopRequireDefault(_pane);

	var _paneContent = __webpack_require__(371);
	...
	var _show = __webpack_require__(373);

	var _show2 = _interopRequireDefault(_show);

	var _showPaneContent = __webpack_require__(374);
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(ShowEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel(clauseIndex) {
	          var comparison = _this5.app.clauseAt(_constants.SECTION_SHOW, clauseIndex);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _control = __webpack_require__(364);
	...
	var ControlView = function (_BaseView) {
	  ...
	  _createClass(ControlView, [{
	    ...
	    get: function get() {
	      ...
	      return {
	        getLabelParts: function getLabelParts(clauseIndex) {
	          var label = _this2.templateConstants.label || _this2.templateHelpers.getLabel(clauseIndex);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = function (Boolean, constants, elementClass, helpers, state, views) {
	    ...
	    return {
	      value: h("div", {
	        "className": [elementClass, constants.class || helpers.getClass()].filter(Boolean).join(' ')
	      }, [function () {
	        var __jade_nodes = [];
	        __jade_nodes.push(h("button", {
	          ...
	          var __jade_nodes = [];
	          var labelParts = helpers.getLabelParts(state.clauseIndex);
	          __jade_nodes.push(labelParts.map(function (part, i) {
	            return function () {
	              ...
	              }, constants.labelConnector || helpers.getLabelConnector(state.clauseIndex)) : undefined);;
	              return __jade_nodes;
	            }.call(this);
	          }));;
	          return __jade_nodes;
	        ...
	        __jade_nodes.push(h("div", {
	          "className": ['pane-container', helpers.isPaneOpen(state.clauseIndex) ? 'visible' : 'hidden'].filter(Boolean).join(' '),
	          "style": {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pane = __webpack_require__(368);
	...
	var PaneView = function (_BaseView) {
	  ...
	  _createClass(PaneView, [{
	    ...
	    get: function get() {
	      ...
	      return {
	        updateSearch: function updateSearch(clauseIndex, search) {
	          return _this2.app.updateSection(_this2.section, clauseIndex, { search: search });
	        }
	      };
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function (Boolean, constants, elementClass, helpers, state, util, views) {
	    var h = __webpack_require__(348);
	    var jade_mixins = {};
	    jade_mixins['pane'] = function (paneViews, paneIndex) {
	      var block = this && this.block,
	          attributes = this && this.attributes || {};

	      return function () {
	        var __jade_nodes = [];
	        var header = constants.header || helpers.getHeader(paneIndex);
	        __jade_nodes.push(header ? h("div", {
	          ...
	          __jade_nodes.push(paneIndex ? h("button", {
	            ...
	            "ev-click": function evClick() {
	              return helpers.updatePaneIndex(state.clauseIndex, paneIndex - 1);
	            }
	          }) : undefined);;
	          return __jade_nodes;
	        }.call(this)]) : undefined);
	        __jade_nodes.push(paneViews.preSearch ? h("div", {
	          "className": ['pre-search'].filter(Boolean).join(' ')
	        }, paneViews.preSearch(state)) : undefined);
	        __jade_nodes.push(constants.search ? h("div", {
	          "className": ['search'].filter(Boolean).join(' ')
	        }, [h("input", {
	          "type": 'text',
	          "ev-input": function evInput(event) {
	            return helpers.updateSearch(state.clauseIndex, event.target.value);
	          }
	        })]) : undefined);
	        ...
	        __jade_nodes.push(paneViews.footer ? h("div", {
	          "className": ['footer'].filter(Boolean).join(' ')
	        }, paneViews.footer(state)) : undefined);;
	        return __jade_nodes;
	      }.call(this);
	    };
	    return {
	      value: h("div", {
	        ...
	        __jade_nodes.push(views.panes ? function () {
	          var __jade_nodes = [];
	          var activeIndex = helpers.getPaneIndex(state.clauseIndex);;
	          __jade_nodes.push(views.panes.map(function (paneViews, paneIndex) {
	            return h("div", {
	              "className": ['pane'].filter(Boolean).join(' '),
	              "style": {
	                transform: 'translateX(' + (paneIndex - activeIndex) * 400 + 'px)'
	              }
	            }, [jade_mixins['pane'].call(this, paneViews, paneIndex)]);
	          }));;
	          return __jade_nodes;
	        }.call(this) : h("div", {
	          "className": ['pane', 'active'].filter(Boolean).join(' ')
	        }, [jade_mixins['pane'].call(this, views)]));;
	        return __jade_nodes;
	      }.call(this)])
	    };
	  ...
	  _createClass(PaneContentView, [{
	    ...
	    get: function get() {
	      ...
	      return {
	        ...
	        updateSection: function updateSection(clauseIndex, data) {
	          return _this2.app.updateSection(_this2.section, clauseIndex, data);
	        }
	      };
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var FILTER_EQUALS = exports.FILTER_EQUALS = 'equals';
	var FILTER_NOT_EQUALS = exports.FILTER_NOT_EQUALS = 'does not equal';
	var FILTER_CONTAINS = exports.FILTER_CONTAINS = 'contains';
	var FILTER_NOT_CONTAINS = exports.FILTER_NOT_CONTAINS = 'does not contain';
	var FILTER_SET = exports.FILTER_SET = 'is set';
	var FILTER_NOT_SET = exports.FILTER_NOT_SET = 'is not set';
	var FILTER_TYPES = exports.FILTER_TYPES = {
	  FILTER_EQUALS: FILTER_EQUALS,
	  FILTER_NOT_EQUALS: FILTER_NOT_EQUALS,
	  FILTER_CONTAINS: FILTER_CONTAINS,
	  FILTER_NOT_CONTAINS: FILTER_NOT_CONTAINS,
	  ...
	  var result_of_with = function (Boolean, elementClass, state, util, views) {
	    ...
	    return {
	      value: h("div", {
	        ...
	        }, views.addControl(state))]) : state.showSection.map(function (comparison, clauseIndex) {
	          return function () {
	            var __jade_nodes = [];
	            ...
	            __jade_nodes.push(h("div", {
	              ...
	              var __jade_nodes = [];
	              __jade_nodes.push(h("h3", 'Show' + (state.showSection.length === 1 ? '' : ' ' + (clauseIndex + 1))));
	              __jade_nodes.push(h("div", {
	                "className": ['control-container'].filter(Boolean).join(' ')
	              }, views.editControl(util.extend(state, {
	                clauseIndex: clauseIndex
	              }))));
	              __jade_nodes.push(clauseIndex === state.showSection.length - 1 ? h("div", {
	                "className": ['control-container'].filter(Boolean).join(' ')
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = function (Boolean, constants, elementClass, helpers, state, util) {
	    ...
	    var selectedValueIndex = state.editing && state.topEvents.indexOf(state.editing.value);
	    return {
	      value: h("div", {
	        "className": [elementClass].filter(Boolean).join(' ')
	      }, [[h("ul", {
	        ...
	        return h("li", {
	          ...
	          "ev-click": function evClick() {
	            return helpers.updateSection(state.clauseIndex, {
	              math: math
	            });
	          }
	      ...
	      }, [state.topEvents.map(function (value, i) {
	        return function () {
	          var __jade_nodes = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _time = __webpack_require__(379);

	var _time2 = _interopRequireDefault(_time);

	var _timePaneContent = __webpack_require__(380);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function (Boolean, elementClass, helpers) {
	    var h = __webpack_require__(348);
	    return {
	      value: h("div", {
	        "className": [elementClass].filter(Boolean).join(' ')
	  ...
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "elementClass" in locals ? locals.elementClass : typeof elementClass !== "undefined" ? elementClass : undefined, "helpers" in locals ? locals.helpers : typeof helpers !== "undefined" ? helpers : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _group = __webpack_require__(384);

	var _group2 = _interopRequireDefault(_group);

	var _groupPaneContent = __webpack_require__(385);
	  ...
	  _createClass(GroupEditControlView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(GroupEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel(clauseIndex) {
	          return (0, _util.renameProperty)(_this5.app.clauseAt(_constants.SECTION_GROUP, clauseIndex).value);
	        }
	      });
	    }
	  }]);
	    ...
	    get: function get() {
	      ...
	      return {
	        isDisabled: function isDisabled() {
	          var showValues = _this7.app.state[_constants.SECTION_SHOW].map(function (clause) {
	            return clause.value;
	          });
	    ...
	    return {
	      value: h("div", {
	        ...
	        __jade_nodes.push(!state.groupSection.length ? h("div", {
	          ...
	          "className": ['control-container'].filter(Boolean).join(' ')
	        }, views.addControl(state))]) : state.groupSection.map(function (group, clauseIndex) {
	          return [h("div", {
	            "className": ['preposition'].filter(Boolean).join(' ')
	            ...
	            var __jade_nodes = [];
	            __jade_nodes.push(h("h3", 'Group' + (state.groupSection.length === 1 ? '' : ' ' + (clauseIndex + 1))));
	            __jade_nodes.push(h("div", {
	              "className": ['control-container'].filter(Boolean).join(' ')
	            }, views.editControl(util.extend(state, {
	              clauseIndex: clauseIndex
	            }))));
	            __jade_nodes.push(state.groupSection.length < 2 && clauseIndex == state.groupSection.length - 1 ? h("div", {
	              "className": ['control-container'].filter(Boolean).join(' ')
	            }, views.addControl(state)) : undefined);;
	            return __jade_nodes;
	          }.call(this)])];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = function (Boolean, constants, elementClass, helpers, state, util) {
	    var h = __webpack_require__(348);
	    var selectedTypeIndex = state.editing && constants.resourceTypeChoices.indexOf(state.editing.type);
	    var selectedValueIndex = state.editing && state.topProperties.indexOf(state.editing.value);
	    return {
	      value: h("div", {
	        "className": [elementClass].filter(Boolean).join(' ')
	      }, [[h("ul", {
	        ...
	        "className": ['column', 'resourceValue'].filter(Boolean).join(' ')
	      }, [state.topProperties.map(function (value, i) {
	        return function () {
	          var __jade_nodes = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _filterPropertyPaneContent = __webpack_require__(390);

	var _filterPropertyPaneContent2 = _interopRequireDefault(_filterPropertyPaneContent);

	var _filterPropertyValuePaneContent = __webpack_require__(391);

	var _filterPropertyValuePaneContent2 = _interopRequireDefault(_filterPropertyValuePaneContent);
	...
	var FilterPropertyPaneContentView = function (_PaneContentView) {
	  ...
	  _createClass(FilterPropertyPaneContentView, [{
	    key: 'section',
	    get: function get() {
	      return _constants.SECTION_FILTER;
	    }
	  }, {
	    key: 'TEMPLATE',
	    get: function get() {
	      return _filterPropertyPaneContent2.default;
	    }
	  }, {
	    key: 'templateConstants',
	    get: function get() {
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(FilterPropertyPaneContentView.prototype), 'templateHelpers', this), {
	        selectProperty: function selectProperty(clauseIndex, value) {
	          _this2.templateHelpers.updateSection(clauseIndex, { value: value });
	          ...
	          setTimeout(function () {
	            var clauseIndex = _this2.app.state[_constants.SECTION_FILTER].indexOf(_this2.app.state.editing);
	            _this2.templateHelpers.updateSection(clauseIndex, { paneIndex: 1 });
	          }, 0);
	        }
	      });
	    }
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(FilterPropertyValuePaneContentView.prototype), 'templateHelpers', this), {
	        showPropertyValues: function showPropertyValues() {
	          return _this4.app.state.editing && _this4.app.state.editing.filterType !== _constants.FILTER_SET && _this4.app.state.editing.filterType !== _constants.FILTER_NOT_SET;
	        }
	      });
	    }
	  }]);
	...
	var FilterPaneView = function (_PaneView) {
	  ...
	  _createClass(FilterPaneView, [{
	    key: 'getPaneIndex',
	    value: function getPaneIndex(clauseIndex) {
	      var clause = this.app.clauseAt(_constants.SECTION_FILTER, clauseIndex);
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(FilterPaneView.prototype), 'templateHelpers', this), {
	        getHeader: function getHeader(paneIndex) {
	          return paneIndex ? 'Property values' : 'Properties';
	        },
	        getPaneIndex: function getPaneIndex(clauseIndex) {
	          return _this6.getPaneIndex(clauseIndex);
	        },
	        updatePaneIndex: function updatePaneIndex(clauseIndex, paneIndex) {
	          return _this6.app.updateSection(_constants.SECTION_FILTER, clauseIndex, { paneIndex: paneIndex });
	        }
	      });
	    }
	  }]);
	  ...
	  _createClass(FilterEditControlView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(FilterEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel(clauseIndex) {
	          var clause = _this9.app.clauseAt(_constants.SECTION_FILTER, clauseIndex);
	          return [(0, _util.renameProperty)(clause.value), clause.filterValue];
	        },
	        getLabelConnector: function getLabelConnector(clauseIndex) {
	          return ' ' + _this9.app.clauseAt(_constants.SECTION_FILTER, clauseIndex).filterType + ' ';
	        }
	      });
	    }
	  }]);
	  ...
	  var result_of_with = function (Boolean, elementClass, state, util, views) {
	    ...
	    return {
	      value: h("div", {
	        ...
	        var __jade_nodes = [];
	        __jade_nodes.push(!state.filterSection.length ? h("div", {
	          "className": ['clause', 'filter'].filter(Boolean).join(' ')
	        }, [h("div", {
	          "className": ['control-container'].filter(Boolean).join(' ')
	        }, views.addControl(state))]) : state.filterSection.map(function (filter, clauseIndex) {
	          return [h("div", {
	            "className": ['preposition'].filter(Boolean).join(' ')
	          }, clauseIndex ? 'and' : 'where'), h("div", {
	            "className": ['clause', 'filter'].filter(Boolean).join(' ')
	          }, [function () {
	            var __jade_nodes = [];
	            __jade_nodes.push(h("div", {
	            ...
	            __jade_nodes.push(clauseIndex == state.filterSection.length - 1 ? h("div", {
	              "className": ['control-container'].filter(Boolean).join(' ')
	            }, views.addControl(state)) : undefined);;
	            return __jade_nodes;
	          }.call(this)])];
	  ...
	  var result_of_with = function (Boolean, constants, elementClass, helpers, state, util) {
	    ...
	    return {
	      value: h("div", {
	        ...
	        "className": ['column'].filter(Boolean).join(' ')
	      }, [constants.resourceTypeChoices.map(function (type, i) {
	        return h("li", {
	          "className": [selectedTypeIndex === i ? 'selected' : ''].filter(Boolean).join(' '),
	          "ev-click": function evClick() {
	        ...
	        return function () {
	          ...
	          __jade_nodes.push(helpers.matchesSearch(util.renameProperty(value)) ? h("li", {
	            "className": [selectedValueIndex === i ? 'selected' : ''].filter(Boolean).join(' '),
	            "ev-click": function evClick() {
	              return helpers.selectProperty(state.clauseIndex, value);
	            }
	          }, util.renameProperty(value)) : undefined);;
	          return __jade_nodes;
	        }.call(this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = function (Boolean, constants, elementClass, helpers, state, util) {
	    var h = __webpack_require__(348);
	    var property = state.editing && state.editing.value;
	    var propertyValues = state.editing && state.topPropertyValues[property] || [];
	    var selectedTypeIndex = state.editing && constants.filterTypeChoices.indexOf(state.editing.filterType);
	    var selectedValueIndex = state.editing && propertyValues.indexOf(state.editing.filterValue);
	    return {
	      value: h("div", {
	        "className": [elementClass].filter(Boolean).join(' ')
	      }, [[h("ul", {
	        "className": ['column'].filter(Boolean).join(' ')
	      }, [constants.filterTypeChoices.map(function (filterType, i) {
	        return h("li", {
	          "className": [selectedTypeIndex === i ? 'selected' : ''].filter(Boolean).join(' '),
	          "ev-click": function evClick() {
	            return helpers.updateSection(state.clauseIndex, {
	        ...
	        var __jade_nodes = [];
	        __jade_nodes.push(helpers.showPropertyValues() ? propertyValues.map(function (filterValue, i) {
	          return function () {
	            var __jade_nodes = [];
	            __jade_nodes.push(helpers.matchesSearch(filterValue) ? h("li", {
	              "className": [selectedValueIndex === i ? 'selected' : ''].filter(Boolean).join(' '),
	              "ev-click": function evClick() {
	                return helpers.updateSection(state.clauseIndex, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _result = __webpack_require__(399);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mixpanelBrowser = __webpack_require__(408);

	var _mixpanelBrowser2 = _interopRequireDefault(_mixpanelBrowser);

	var _rollbarBrowser = __webpack_require__(409);
