...
/***/ function(module, exports, __webpack_require__) {
	...
	if (_constants.IS_WITHIN_MP_PLATFORM_IFRAME) {
	  (function () {
	    var parentFrame = new _framesg2.default(window.parent, 'irb', {
	      startApp: function startApp(parentData) {
	        var app = new _app2.default('app', null, { parentFrame: parentFrame });
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  switch (section) {
	    case _constants.SECTION_SHOW:
	      return {
	        ...
	        value: _constants.RESOURCE_VALUE_TOP_EVENTS,
	        search: ''
	      };
	...
	function validateClause(clause) {
	  if (clause.section === _constants.SECTION_GROUP && !clause.value) {
	    throw new Error('invalid group clause: no value present');
	  } else if (clause.section === _constants.SECTION_TIME) {
	    if (!clause.unit) {
	...
	}, _defineProperty(_INITIAL_STATE, _constants.SECTION_SHOW, [createNewClause(_constants.SECTION_SHOW)]), _defineProperty(_INITIAL_STATE, _constants.SECTION_TIME, [createNewClause(_constants.SECTION_TIME)]), _defineProperty(_INITIAL_STATE, _constants.SECTION_GROUP, []), _defineProperty(_INITIAL_STATE, _constants.SECTION_FILTER, []), _defineProperty(_INITIAL_STATE, 'events', []), _defineProperty(_INITIAL_STATE, 'properties', []), _defineProperty(_INITIAL_STATE, 'query', {}), _defineProperty(_INITIAL_STATE, 'result', {}), _INITIAL_STATE);
	...
	var IrbApp = function (_BaseApp) {
	  ...
	  function IrbApp(elID) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(IrbApp).call(this, elID, INITIAL_STATE, attrs));
	...
	var BaseApp = function (_App) {
	  ...
	  function BaseApp(elID) {
	    ...
	    if (options.parentFrame) {
	      _this.parentFrame = attrs.parentFrame;
	  ...
	  _createClass(BaseApp, [{
	    ...
	    key: 'onClickOutside',
	    value: function onClickOutside(elementClass, handler) {
	    ...
	    value: function clickOutsideHandler(event) {
	      ...
	      do {
	        for (var i = 0; i < this.clickOutsideClasses.length; i++) {
	      ...
	      for (var _i = 0; _i < this.clickOutsideHandlers.length; _i++) {
	        this.clickOutsideHandlers[_i](event);
	      }
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _builder = __webpack_require__(369);
	
	var _builder2 = _interopRequireDefault(_builder);
	
	var _result = __webpack_require__(412);
	
	var _result2 = _interopRequireDefault(_result);
	
	var _irb = __webpack_require__(417);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseView = function (_View) {
	  ...
	  _createClass(BaseView, [{
	    ...
	    value: function postRender() {
	      this.onRendered && this.onRendered();
	      Object.values(this._views).forEach(function (view) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autoSizingInput = __webpack_require__(368);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VText = __webpack_require__(355);
	var isVNode = __webpack_require__(351);
	var isVText = __webpack_require__(356);
	var isWidget = __webpack_require__(352);
	var isHook = __webpack_require__(354);
	var isVThunk = __webpack_require__(353);
	
	var parseTag = __webpack_require__(357);
	var softSetHook = __webpack_require__(359);
	var evHook = __webpack_require__(360);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isVNode = __webpack_require__(351)
	var isWidget = __webpack_require__(352)
	var isThunk = __webpack_require__(353)
	var isVHook = __webpack_require__(354)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var split = __webpack_require__(358);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EvStore = __webpack_require__(361);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OneVersionConstraint = __webpack_require__(362);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Individual = __webpack_require__(363);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _builder = __webpack_require__(409);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _control = __webpack_require__(371);
	
	var _control2 = _interopRequireDefault(_control);
	
	var _pane = __webpack_require__(375);
	
	var _pane2 = _interopRequireDefault(_pane);
	
	var _paneContent = __webpack_require__(379);
	...
	var ShowControlView = function (_ControlView) {
	  _inherits(ShowControlView, _ControlView);
	
	  function ShowControlView() {
	    _classCallCheck(this, ShowControlView);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ShowControlView).apply(this, arguments));
	  }
	
	  _createClass(ShowControlView, [{
	    key: 'VIEWS',
	    get: function get() {
	      return {
	...
	var AddControlView = function (_ShowControlView) {
	  _inherits(AddControlView, _ShowControlView);
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(AddControlView.prototype), 'templateHelpers', this), {
	        isPaneOpen: function isPaneOpen() {
	          return _this6.app.isAddingClause(_constants.SECTION_SHOW);
	        },
	        openPane: function openPane() {
	          return _this6.app.startAddingClause(_constants.SECTION_SHOW);
	        }
	      });
	    }
	  }]);
	...
	var EditControlView = function (_ShowControlView2) {
	  _inherits(EditControlView, _ShowControlView2);
	  ...
	  _createClass(EditControlView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(EditControlView.prototype), 'templateHelpers', this), {
	        isPaneOpen: function isPaneOpen(props) {
	          return _this8.app.isEditingClause(_constants.SECTION_SHOW, props.index);
	        },
	        openPane: function openPane(props) {
	          return _this8.app.startEditingClause(_constants.SECTION_SHOW, props.index);
	        },
	        getLabel: function getLabel(props) {
	          var comparison = _this8.app.clauseAt(_constants.SECTION_SHOW, props.index);
	...
	var ControlView = function (_BaseView) {
	  ...
	  _createClass(ControlView, [{
	    ...
	    value: function setApp() {
	      ...
	      this.app.onClickOutside(this.className, function () {
	        return _this2.app.stopEditingClause();
	      });
	    }
	  }, {
	    key: 'TEMPLATE',
	    ...
	    get: function get() {
	      ...
	      return {
	        getLabelParts: function getLabelParts(props) {
	          var label = _this3.templateConstants.label || _this3.templateHelpers.getLabel(props);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = (function(Boolean, LabelParts, className, constants, helpers, props, state, views) {
	    var h = __webpack_require__(346);
	    return {
	      value: h("div", {
	        ...
	        [h("button", {
	          "ev-click": () => helpers.openPane(props),
	        }, [(function() {
	          var __jade_nodes = [];
	          let labelParts = helpers.getLabelParts(props);
	          __jade_nodes.push((labelParts).map(function(part, i) {
	            return (function() {
	              ...
	              }, (constants.labelConnector || helpers.getLabelConnector(props)))) : undefined);;
	              return __jade_nodes
	            }).call(this)
	          }));;
	          return __jade_nodes
	        }).call(this)]), h("div", {
	          "className": ['pane-container', helpers.isPaneOpen(props) ? 'visible' : 'hidden'].filter(Boolean).join(' '),
	        }, (views.pane(state, props))), ]
	      ])
	    };
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "LabelParts" in locals ? locals.LabelParts : typeof LabelParts !== "undefined" ? LabelParts : undefined, "className" in locals ? locals.className : typeof className !== "undefined" ? className : undefined, "constants" in locals ? locals.constants : typeof constants !== "undefined" ? constants : undefined, "helpers" in locals ? locals.helpers : typeof helpers !== "undefined" ? helpers : undefined, "props" in locals ? locals.props : typeof props !== "undefined" ? props : undefined, "state" in locals ? locals.state : typeof state !== "undefined" ? state : undefined, "views" in locals ? locals.views : typeof views !== "undefined" ? views : undefined));
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
	    ...
	    get: function get() {
	      ...
	      return {
	        updateSearch: function updateSearch(event) {
	          return _this2.app.updateSection({ search: event.target.value });
	        }
	      };
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = (function(Boolean, className, constants, handlers, helpers, props, state, views) {
	    var h = __webpack_require__(346);
	    return {
	      value: h("div", {
	        "className": [className].filter(Boolean).join(' '),
	        ...
	        }, (constants.header || helpers.getHeader(props)))) : undefined);
	        __jade_nodes.push((views.preSearch) ? (h("div", {
	          "className": ['pre-search'].filter(Boolean).join(' '),
	        }, (views.preSearch(state, props)))) : undefined);
	        __jade_nodes.push((constants.search) ? (h("div", {
	          "className": ['search'].filter(Boolean).join(' '),
	        }, [h("input", {
	          "type": 'text',
	          "ev-input": handlers.updateSearch,
	        })])) : undefined);
	        __jade_nodes.push((views.content) ? (h("div", {
	          "className": ['content'].filter(Boolean).join(' '),
	        }, (views.content(state, props)))) : undefined);
	        __jade_nodes.push((views.footer) ? (h("div", {
	          "className": ['footer'].filter(Boolean).join(' '),
	        }, (views.footer(state, props)))) : undefined);;
	        return __jade_nodes
	      }).call(this)])
	    };
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "className" in locals ? locals.className : typeof className !== "undefined" ? className : undefined, "constants" in locals ? locals.constants : typeof constants !== "undefined" ? constants : undefined, "handlers" in locals ? locals.handlers : typeof handlers !== "undefined" ? handlers : undefined, "helpers" in locals ? locals.helpers : typeof helpers !== "undefined" ? helpers : undefined, "props" in locals ? locals.props : typeof props !== "undefined" ? props : undefined, "state" in locals ? locals.state : typeof state !== "undefined" ? state : undefined, "views" in locals ? locals.views : typeof views !== "undefined" ? views : undefined));
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports) {
	...
	var IS_WITHIN_MP_PLATFORM_IFRAME = exports.IS_WITHIN_MP_PLATFORM_IFRAME = window.parent && window.parent.mixpanel && window.parent !== window;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = (function(Boolean, className, constants, helpers, props, state) {
	    var h = __webpack_require__(346);
	      ...
	      value: h("div", {
	        ...
	        [h("ul", {
	          ...
	          return h("li", {
	            ...
	            "ev-click": () => helpers.updateSection(props.index, {
	              math
	            }),
	          ...
	          return (function() {
	            var __jade_nodes = [];
	            __jade_nodes.push((helpers.matchesSearch(helpers.renameEvent(value))) ? (h("li", {
	              "className": [selectedValueIndex === i ? 'selected' : ''].filter(Boolean).join(' '),
	              "ev-click": () => helpers.updateSection(props.index, {
	                value
	              }),
	            }, (helpers.renameEvent(value)))) : undefined);;
	            return __jade_nodes
	          }).call(this)
	        })]), ]
	      ])
	    };
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "className" in locals ? locals.className : typeof className !== "undefined" ? className : undefined, "constants" in locals ? locals.constants : typeof constants !== "undefined" ? constants : undefined, "helpers" in locals ? locals.helpers : typeof helpers !== "undefined" ? helpers : undefined, "props" in locals ? locals.props : typeof props !== "undefined" ? props : undefined, "state" in locals ? locals.state : typeof state !== "undefined" ? state : undefined));
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditControlView = function (_ControlView) {
	  _inherits(EditControlView, _ControlView);
	  ...
	  _createClass(EditControlView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(EditControlView.prototype), 'templateHelpers', this), {
	        isPaneOpen: function isPaneOpen() {
	          return _this5.app.isEditingClause(_constants.SECTION_TIME, 0);
	        },
	        openPane: function openPane() {
	          return _this5.app.startEditingClause(_constants.SECTION_TIME, 0);
	        },
	    ...
	    return {
	      value: h("div", {
	        ...
	        __jade_nodes.push((state.timeSection.length) ? ([h("div", {
	          ...
	          "className": ['control-container'].filter(Boolean).join(' '),
	        }, (views.editControl(state))), ]), ]) : undefined);;
	        return __jade_nodes
	      }).call(this)])
	    };
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "className" in locals ? locals.className : typeof className !== "undefined" ? className : undefined, "state" in locals ? locals.state : typeof state !== "undefined" ? state : undefined, "views" in locals ? locals.views : typeof views !== "undefined" ? views : undefined));
	  ...
	  var result_of_with = (function(Boolean, className, helpers) {
	    ...
	    return {
	      value: h("div", {
	        ...
	        "ev-change": event => helpers.updateSection({
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(GroupPaneContentView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(GroupPaneContentView.prototype), 'templateHelpers', this), {
	        capitalize: _util.capitalize,
	        renameProperty: _util.renameProperty,
	        updateSection: function updateSection(index, data) {
	...
	var GroupControlView = function (_ControlView) {
	  _inherits(GroupControlView, _ControlView);
	
	  function GroupControlView() {
	    _classCallCheck(this, GroupControlView);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(GroupControlView).apply(this, arguments));
	  }
	
	  _createClass(GroupControlView, [{
	    key: 'VIEWS',
	    get: function get() {
	      return {
	  ...
	  return GroupControlView;
	}(_control2.default);
	
	var AddControlView = function (_GroupControlView) {
	  _inherits(AddControlView, _GroupControlView);
	  ...
	  _createClass(AddControlView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(AddControlView.prototype), 'templateHelpers', this), {
	        isPaneOpen: function isPaneOpen() {
	          return _this6.app.isAddingClause(_constants.SECTION_GROUP);
	        },
	        openPane: function openPane() {
	          return _this6.app.startAddingClause(_constants.SECTION_GROUP);
	        }
	      });
	    }
	  }]);
	...
	var EditControlView = function (_GroupControlView2) {
	  _inherits(EditControlView, _GroupControlView2);
	  ...
	  _createClass(EditControlView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(EditControlView.prototype), 'templateHelpers', this), {
	        isPaneOpen: function isPaneOpen(props) {
	          return _this8.app.isEditingClause(_constants.SECTION_GROUP, props.index);
	        },
	        openPane: function openPane(props) {
	          return _this8.app.startEditingClause(_constants.SECTION_GROUP, props.index);
	        },
	        getLabel: function getLabel(props) {
	          return (0, _util.renameProperty)(_this8.app.clauseAt(_constants.SECTION_GROUP, props.index).value);
	        }
	      });
	    }
	  }]);
	      ...
	      value: h("div", {
	        ...
	        __jade_nodes.push((!state.groupSection.length) ? (h("div", {
	          ...
	          return [h("div", {
	            ...
	            __jade_nodes.push((index == state.groupSection.length - 1) ? (h("div", {
	              "className": ['control-container'].filter(Boolean).join(' '),
	            }, (views.addControl(state)))) : undefined);;
	            return __jade_nodes
	          }).call(this)]), ]
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = (function(Boolean, className, constants, helpers, props, state) {
	    var h = __webpack_require__(346);
	    let selectedTypeIndex = state.editing && constants.resourceTypeChoices.indexOf(state.editing.type);
	    let selectedValueIndex = state.editing && state.properties.indexOf(state.editing.value);
	    return {
	      value: h("div", {
	        "className": [className].filter(Boolean).join(' '),
	      }, [
	        [h("ul", {
	          ...
	          return (function() {
	            var __jade_nodes = [];
	            __jade_nodes.push((helpers.matchesSearch(helpers.renameProperty(value))) ? (h("li", {
	              "className": [selectedValueIndex === i ? 'selected' : ''].filter(Boolean).join(' '),
	              "ev-click": () => helpers.updateSection(props.index, {
	                value
	              }),
	            }, (helpers.renameProperty(value)))) : undefined);;
	            return __jade_nodes
	          }).call(this)
	        })]), ]
	      ])
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = (function(Boolean) {
	    ...
	    return {
	      value: h("div", {
	        "className": ['section', 'filter-view'].filter(Boolean).join(' '),
	      }, [h("div", {
	        "className": ['clause', 'filter'].filter(Boolean).join(' '),
	      }, [h("div", {
	        "className": ['add-control-view', 'verb'].filter(Boolean).join(' '),
	      }, [h("button", {
	        "className": ['add'].filter(Boolean).join(' '),
	      }, ["Filter"])])])])
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chart = __webpack_require__(413);
	
	var _result = __webpack_require__(414);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mixpanelBrowser = __webpack_require__(423);
	
	var _mixpanelBrowser2 = _interopRequireDefault(_mixpanelBrowser);
	
	var _rollbarBrowser = __webpack_require__(424);
