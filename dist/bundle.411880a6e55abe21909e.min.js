...
/***/ function(module, exports, __webpack_require__) {
	...
	var _framesg = __webpack_require__(291);
	...
	var _tracking = __webpack_require__(425);
	...
	if (_constants.IS_WITHIN_MP_PLATFORM_IFRAME) {
	  (function () {
	    var parentFrame = new _framesg2.default(window.parent, 'interactive-report-builder', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baseApp = __webpack_require__(293);

	var _baseApp2 = _interopRequireDefault(_baseApp);

	var _irb = __webpack_require__(342);
	...
	function createNewClause(section, data) {
	  switch (section) {
	    case _constants.SECTION_SHOW:
	      return (0, _util.extend)({
	        section: _constants.SECTION_SHOW,
	        math: _constants.MATH_TOTAL,
	        type: _constants.RESOURCE_EVENTS,
	        value: null,
	        search: ''
	      }, data);
	    case _constants.SECTION_TIME:
	      var to = new Date();
	      var from = new Date();
	      ...
	      return (0, _util.extend)({
	        section: _constants.SECTION_TIME,
	        unit: _constants.TIME_UNIT_HOUR,
	        range: {
	          from: from,
	          to: to
	        }
	      }, data);
	    case _constants.SECTION_GROUP:
	      return (0, _util.extend)({
	        section: _constants.SECTION_GROUP,
	        type: _constants.RESOURCE_EVENTS,
	        value: null,
	        search: ''
	      }, data);
	    case _constants.SECTION_FILTER:
	      return (0, _util.extend)({
	        section: _constants.SECTION_FILTER,
	        type: _constants.RESOURCE_EVENTS,
	        property: null,
	        value: null,
	        search: ''
	...
	function validateClause(clause) {
	  if (clause.section === _constants.SECTION_TIME) {
	    if (!clause.unit) {
	      throw new Error('invalid time clause: no unit present');
	    } else if (!(clause.range && clause.range.from instanceof Date && clause.range.to instanceof Date)) {
	...
	function validateSection(section) {
	  if (section.length > 1 && section[0].section === _constants.SECTION_TIME) {
	    throw new Error('invalid time section: number of clauses cannot exceed 1');
	  }
	}

	var INITIAL_STATE = (_INITIAL_STATE = {
	  $screen: _constants.SCREEN_MAIN,
	  reportName: 'Untitled report'
	}, _defineProperty(_INITIAL_STATE, _constants.SECTION_SHOW, [createNewClause(_constants.SECTION_SHOW, { value: _constants.RESOURCE_VALUE_TOP_EVENTS })]), _defineProperty(_INITIAL_STATE, _constants.SECTION_TIME, [createNewClause(_constants.SECTION_TIME)]), _defineProperty(_INITIAL_STATE, _constants.SECTION_GROUP, []), _defineProperty(_INITIAL_STATE, _constants.SECTION_FILTER, []), _defineProperty(_INITIAL_STATE, 'events', []), _defineProperty(_INITIAL_STATE, 'properties', []), _defineProperty(_INITIAL_STATE, 'query', {}), _defineProperty(_INITIAL_STATE, 'result', {}), _INITIAL_STATE);
	...
	var IrbApp = function (_BaseApp) {
	  ...
	  function IrbApp(elID) {
	    ...
	    window.MP.api.topEvents().done(function (results) {
	      return _this.update({ events: [_constants.RESOURCE_VALUE_TOP_EVENTS].concat(Object.values(results.values())) });
	    });

	    window.MP.api.topProperties().done(function (results) {
	      var props = results.values();
	      _this.update({ properties: Object.keys(props).sort(function (a, b) {
	  ...
	  _createClass(IrbApp, [{
	    ...
	    value: function main() {
	      ...
	      this.update({ $screen: _constants.SCREEN_MAIN });
	    }
	  }, {
	    key: 'update',
	    value: function update() {
	      _get(Object.getPrototypeOf(IrbApp.prototype), 'update', this).apply(this, arguments);
	      this.query();
	    }
	    ...
	    key: 'clauseAt',
	    value: function clauseAt(sectionType, index) {
	    ...
	    key: 'isEditingClause',
	    value: function isEditingClause(sectionType, index) {
	      return this.state.editing && this.state.editing.section === sectionType && this.state[sectionType].indexOf(this.state.editing) === index;
	    }
	  }, {
	    key: 'isClauseValid',
	    value: function isClauseValid(clause) {
	      try {
	    ...
	    key: 'isSectionValid',
	    value: function isSectionValid(section) {
	      try {
	    ...
	    value: function startEditingClause(sectionType, index) {
	    ...
	    key: 'updateSection',
	    value: function updateSection(sectionType, index, clauseData) {
	      var section = this.state[sectionType];
	      var clause = section[index];
	      var newClause = (0, _util.extend)(clause || this.state.editing || {}, clauseData);
	      var newState = { editing: newClause };

	      if (this.isClauseValid(newClause)) {
	        var newSection = void 0;

	        if (clause) {
	          newSection = (0, _util.replaceAtIndex)(section, index, newClause);
	        } else {
	    ...
	    key: 'removeClause',
	    value: function removeClause(sectionType, index) {
	      this.update(_defineProperty({}, sectionType, (0, _util.removeAtIndex)(this.state[sectionType], index)));
	    }
	  }, {
	    key: 'query',
	    value: function query() {
	      ...
	      var time = this.state[_constants.SECTION_TIME][0];
	      var query = {
	        events: this.state[_constants.SECTION_SHOW].map(function (clause) {
	          return clause.value;
	        }),
	        segments: this.state[_constants.SECTION_GROUP].map(function (clause) {
	          return clause.value;
	        }),
	        unit: time.unit,
	      ...
	      if (query.events.indexOf(_constants.RESOURCE_VALUE_TOP_EVENTS) !== -1) {
	        query.events = (0, _util.removeAtIndex)(this.state.events, this.state.events.indexOf(_constants.RESOURCE_VALUE_TOP_EVENTS));
	      }

	      if (Object.keys(query).some(function (key) {
	        return JSON.stringify(query[key]) !== JSON.stringify(_this2.state.query[key]);
	      })) {
	        ...
	        if (events.length) {
	          var endpoint = 'events';
	          var params = { unit: unit, from: from, to: to, event: events };
	          ...
	          window.MP.api.query('api/2.0/' + endpoint, params).done(function (results) {
	            return _this2.update({ result: results.data.values });
	          });
	        }
	      }
	    ...
	    key: 'SCREENS',
	    get: function get() {
	      return _defineProperty({}, _constants.SCREEN_MAIN, new _irb2.default());
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parentFrame = __webpack_require__(341);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createElement = __webpack_require__(296);
	...
	var _patch = __webpack_require__(314);

	var _patch2 = _interopRequireDefault(_patch);

	var _domDelegator = __webpack_require__(319);

	var _domDelegator2 = _interopRequireDefault(_domDelegator);

	var _mainLoop = __webpack_require__(332);
	...
	var App = function () {
	  function App(elID) {
	    ...
	    for (var k in this._screens) {
	      this._screens[k].setApp(this);
	    }
	    this._render = function (state) {
	      return _this._screens[_this.state.$screen].render(state);
	    };
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createElement = __webpack_require__(297)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var document = __webpack_require__(298)

	var applyProperties = __webpack_require__(300)

	var isVNode = __webpack_require__(303)
	var isVText = __webpack_require__(305)
	var isWidget = __webpack_require__(306)
	var handleThunk = __webpack_require__(307)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var minDoc = __webpack_require__(299);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHook = __webpack_require__(302)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var version = __webpack_require__(304)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isVText = __webpack_require__(305)
	var isWidget = __webpack_require__(306)
	var isThunk = __webpack_require__(308)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var diff = __webpack_require__(310)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VPatch = __webpack_require__(312)
	var isVNode = __webpack_require__(303)
	var isVText = __webpack_require__(305)
	var isWidget = __webpack_require__(306)
	var isThunk = __webpack_require__(308)
	...
	var diffProps = __webpack_require__(313)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var patch = __webpack_require__(315)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var render = __webpack_require__(297)
	var domIndex = __webpack_require__(316)
	var patchOp = __webpack_require__(317)
	module.exports = patch
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateWidget = __webpack_require__(318)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Individual = __webpack_require__(320)
	var cuid = __webpack_require__(321)
	var globalDocument = __webpack_require__(298)

	var DOMDelegator = __webpack_require__(322)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var globalDocument = __webpack_require__(298)
	var EvStore = __webpack_require__(323)
	var createStore = __webpack_require__(326)

	var addEvent = __webpack_require__(328)
	var removeEvent = __webpack_require__(329)
	var ProxyEvent = __webpack_require__(330)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OneVersionConstraint = __webpack_require__(324);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Individual = __webpack_require__(325);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hiddenStore = __webpack_require__(327);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var inherits = __webpack_require__(331)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var raf = __webpack_require__(333)
	var TypedError = __webpack_require__(335)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var now = __webpack_require__(334)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var extend = __webpack_require__(338)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _builder = __webpack_require__(370);

	var _builder2 = _interopRequireDefault(_builder);

	var _result = __webpack_require__(415);

	var _result2 = _interopRequireDefault(_result);

	var _irb = __webpack_require__(420);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseView = function (_View) {
	  ...
	  _createClass(BaseView, [{
	    ...
	    key: 'className',
	    get: function get() {
	      return this.constructor.name.split(/(?=[A-Z])/).map(function (word) {
...
/***/ function(module, exports) {
	...
	function extend() {
	  return Object.assign.apply(Object, _toConsumableArray([{}].concat(Array.prototype.slice.call(arguments))));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autoSizingInput = __webpack_require__(369);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function (Boolean, className, handlers, state) {
	  ...
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "className" in locals ? locals.className : typeof className !== "undefined" ? className : undefined, "handlers" in locals ? locals.handlers : typeof handlers !== "undefined" ? handlers : undefined, "state" in locals ? locals.state : typeof state !== "undefined" ? state : undefined);
...
/***/ function(module, exports) {
	...
	var AutoSizingInput = function (_HTMLElement) {
	  _inherits(AutoSizingInput, _HTMLElement);

	  function AutoSizingInput() {
	    _classCallCheck(this, AutoSizingInput);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(AutoSizingInput).apply(this, arguments));
	  }

	  _createClass(AutoSizingInput, [{
	    key: 'createdCallback',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _show = __webpack_require__(371);
	...
	var _group = __webpack_require__(398);
	...
	var _builder = __webpack_require__(412);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _control = __webpack_require__(372);

	var _pane = __webpack_require__(376);

	var _pane2 = _interopRequireDefault(_pane);

	var _paneContent = __webpack_require__(380);
	...
	var _show = __webpack_require__(382);

	var _show2 = _interopRequireDefault(_show);

	var _showPaneContent = __webpack_require__(383);
	  ...
	  _createClass(ShowPaneContentView, [{
	    ...
	    get: function get() {
	      return (0, _util.extend)(_get(Object.getPrototypeOf(ShowPaneContentView.prototype), 'templateConstants', this), {
	        mathChoices: Object.values(_constants.MATH_TYPES),
	        resourceTypeChoices: Object.values(_constants.RESOURCE_TYPES)
	      });
	    }
	  }, {
	    key: 'templateHelpers',
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(ShowPaneContentView.prototype), 'templateHelpers', this), {
	        updateSection: function updateSection(index, data) {
	          return _this2.app.updateSection(_constants.SECTION_SHOW, index, data);
	        }
	      });
	    }
	  }]);
	...
	var ShowPaneView = function (_PaneView) {
	  ...
	  _createClass(ShowPaneView, [{
	    ...
	    get: function get() {
	      ...
	      return {
	        updateSearch: function updateSearch(index, search) {
	          return _this4.app.updateSection(_constants.SECTION_SHOW, index, { search: search });
	        }
	      };
	    }
	  }]);
	...
	var ShowAddControlView = function (_AddControlView) {
	  ...
	  _createClass(ShowAddControlView, [{
	    key: 'section',
	    get: function get() {
	      return _constants.SECTION_SHOW;
	    }
	  }, {
	    key: 'VIEWS',
	    get: function get() {
	...
	var ShowEditControlView = function (_EditControlView) {
	  ...
	  _createClass(ShowEditControlView, [{
	    ...
	    key: 'templateConstants',
	    get: function get() {
	      return (0, _util.extend)(_get(Object.getPrototypeOf(ShowEditControlView.prototype), 'templateConstants', this), {
	        labelConnector: ' of '
	      });
	    }
	  }, {
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(ShowEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel(index) {
	          var comparison = _this7.app.clauseAt(_constants.SECTION_SHOW, index);
	          var math = (0, _util.capitalize)(comparison.math);
	          var value = comparison.value === _constants.RESOURCE_VALUE_TOP_EVENTS ? 'Top ' + (0, _util.capitalize)(comparison.type) : comparison.value;

	          return [math, (0, _util.renameEvent)(value)];
	        }
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _control = __webpack_require__(373);
	...
	var ControlView = function (_BaseView) {
	  ...
	  _createClass(ControlView, [{
	    ...
	    get: function get() {
	      ...
	      return {
	        getLabelParts: function getLabelParts(index) {
	          var label = _this2.templateConstants.label || _this2.templateHelpers.getLabel(index);
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(EditControlView.prototype), 'templateHelpers', this), {
	        removeClause: function removeClause(index) {
	          return _this6.app.removeClause(_this6.section, index);
	        },
	        isPaneOpen: function isPaneOpen(index) {
	          return _this6.app.isEditingClause(_this6.section, index);
	        },
	        openPane: function openPane(index) {
	          return _this6.app.startEditingClause(_this6.section, index);
	        }
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function (Boolean, className, constants, helpers, state, views) {
	    var h = __webpack_require__(347);
	    return {
	      value: h("div", {
	        "className": [className, constants.class || helpers.getClass()].filter(Boolean).join(' ')
	      }, [function () {
	        var __jade_nodes = [];
	        __jade_nodes.push(h("button", {
	          "className": ['modify'].filter(Boolean).join(' '),
	          "ev-click": function evClick(event) {
	            return helpers.updatePosition(event) && helpers.openPane(state.index);
	          }
	        }, [function () {
	          var __jade_nodes = [];
	          var labelParts = helpers.getLabelParts(state.index);
	          __jade_nodes.push(labelParts.map(function (part, i) {
	            return function () {
	              var __jade_nodes = [];
	              __jade_nodes.push(h("span", part));
	              __jade_nodes.push(i < labelParts.length - 1 ? h("span", {
	                "className": ['preposition'].filter(Boolean).join(' ')
	              }, constants.labelConnector || helpers.getLabelConnector(state.index)) : undefined);;
	              return __jade_nodes;
	            }.call(this);
	          }));;
	          return __jade_nodes;
	        ...
	        __jade_nodes.push(constants.showRemove ? h("button", {
	          ...
	          "ev-click": function evClick() {
	            return helpers.removeClause(state.index);
	          }
	        }) : undefined);
	        __jade_nodes.push(h("div", {
	          "className": ['pane-container', helpers.isPaneOpen(state.index) ? 'visible' : 'hidden'].filter(Boolean).join(' '),
	          "style": {
	  ...
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "className" in locals ? locals.className : typeof className !== "undefined" ? className : undefined, "constants" in locals ? locals.constants : typeof constants !== "undefined" ? constants : undefined, "helpers" in locals ? locals.helpers : typeof helpers !== "undefined" ? helpers : undefined, "state" in locals ? locals.state : typeof state !== "undefined" ? state : undefined, "views" in locals ? locals.views : typeof views !== "undefined" ? views : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pane = __webpack_require__(377);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function (Boolean, className, constants, handlers, helpers, state, views) {
	    var h = __webpack_require__(347);
	    return {
	      value: h("div", {
	        "className": [className].filter(Boolean).join(' ')
	        ...
	        var __jade_nodes = [];
	        __jade_nodes.push(constants.header || helpers.getHeader ? h("div", {
	          "className": ['header'].filter(Boolean).join(' ')
	        }, constants.header || helpers.getHeader(state)) : undefined);
	        __jade_nodes.push(views.preSearch ? h("div", {
	          "className": ['pre-search'].filter(Boolean).join(' ')
	        }, views.preSearch(state)) : undefined);
	        __jade_nodes.push(constants.search ? h("div", {
	          "className": ['search'].filter(Boolean).join(' ')
	        }, [h("input", {
	          "type": 'text',
	          "ev-input": function evInput(event) {
	            return handlers.updateSearch(state.index, event.target.value);
	          }
	        })]) : undefined);
	        __jade_nodes.push(views.content ? h("div", {
	          "className": ['content'].filter(Boolean).join(' ')
	        }, views.content(state)) : undefined);
	        __jade_nodes.push(views.footer ? h("div", {
	          "className": ['footer'].filter(Boolean).join(' ')
	        }, views.footer(state)) : undefined);;
	        return __jade_nodes;
	      }.call(this)])
	    };
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "className" in locals ? locals.className : typeof className !== "undefined" ? className : undefined, "constants" in locals ? locals.constants : typeof constants !== "undefined" ? constants : undefined, "handlers" in locals ? locals.handlers : typeof handlers !== "undefined" ? handlers : undefined, "helpers" in locals ? locals.helpers : typeof helpers !== "undefined" ? helpers : undefined, "state" in locals ? locals.state : typeof state !== "undefined" ? state : undefined, "views" in locals ? locals.views : typeof views !== "undefined" ? views : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
	    ...
	    get: function get() {
	      ...
	      return {
	        matchesSearch: function matchesSearch(value) {
	          return _this2.app.state.editing && (!_this2.app.state.editing.search || value.toLowerCase().indexOf(_this2.app.state.editing.search.toLowerCase()) === 0);
	        }
	      };
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var IS_WITHIN_MP_PLATFORM_IFRAME = exports.IS_WITHIN_MP_PLATFORM_IFRAME = window.parent !== window;

	var SCREEN_MAIN = exports.SCREEN_MAIN = 'main';

	var SECTION_SHOW = exports.SECTION_SHOW = 'showSection';
	var SECTION_GROUP = exports.SECTION_GROUP = 'groupSection';
	var SECTION_TIME = exports.SECTION_TIME = 'timeSection';
	var SECTION_FILTER = exports.SECTION_FILTER = 'filterSection';
	var SECTION_TYPES = exports.SECTION_TYPES = {
	...
	var RESOURCE_EVENTS = exports.RESOURCE_EVENTS = 'events';
	var RESOURCE_PEOPLE = exports.RESOURCE_PEOPLE = 'people';
	var RESOURCE_TYPES = exports.RESOURCE_TYPES = {
	  RESOURCE_EVENTS: RESOURCE_EVENTS,
	  RESOURCE_PEOPLE: RESOURCE_PEOPLE
	};

	var RESOURCE_VALUE_TOP_EVENTS = exports.RESOURCE_VALUE_TOP_EVENTS = '$top_events';

	var MATH_TOTAL = exports.MATH_TOTAL = 'total';
	var MATH_UNIQUE = exports.MATH_UNIQUE = 'unique';
	var MATH_AVERAGE = exports.MATH_AVERAGE = 'average';
	var MATH_TYPES = exports.MATH_TYPES = {
	  MATH_TOTAL: MATH_TOTAL,
	  MATH_UNIQUE: MATH_UNIQUE,
	  MATH_AVERAGE: MATH_AVERAGE
	};

	var TIME_UNIT_HOUR = exports.TIME_UNIT_HOUR = 'hour';
	var TIME_UNIT_DAY = exports.TIME_UNIT_DAY = 'day';
	var TIME_UNIT_WEEK = exports.TIME_UNIT_WEEK = 'week';
	var TIME_UNIT_MONTH = exports.TIME_UNIT_MONTH = 'month';
	var TIME_UNIT_QUARTER = exports.TIME_UNIT_QUARTER = 'quarter';
	var TIME_UNIT_YEAR = exports.TIME_UNIT_YEAR = 'year';
	var TIME_UNIT_TYPES = exports.TIME_UNIT_TYPES = {
	  TIME_UNIT_HOUR: TIME_UNIT_HOUR,
	  TIME_UNIT_DAY: TIME_UNIT_DAY,
	  TIME_UNIT_WEEK: TIME_UNIT_WEEK,
	  TIME_UNIT_MONTH: TIME_UNIT_MONTH,
	  TIME_UNIT_QUARTER: TIME_UNIT_QUARTER,
	  TIME_UNIT_YEAR: TIME_UNIT_YEAR
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function (Boolean, className, state, util, views) {
	    var h = __webpack_require__(347);
	    return {
	      value: h("div", {
	        ...
	        var __jade_nodes = [];
	        __jade_nodes.push(!state.showSection.length ? h("div", {
	          "className": ['clause', 'comparison'].filter(Boolean).join(' ')
	        }, [h("h3"), h("div", {
	          "className": ['control-container'].filter(Boolean).join(' ')
	        }, views.addControl(state))]) : state.showSection.map(function (comparison, index) {
	          return function () {
	            var __jade_nodes = [];
	            __jade_nodes.push(index ? h("div", {
	              "className": ['preposition'].filter(Boolean).join(' ')
	            }, ["and"]) : undefined);
	            __jade_nodes.push(h("div", {
	              "className": ['clause', 'comparison'].filter(Boolean).join(' ')
	              ...
	              var __jade_nodes = [];
	              __jade_nodes.push(h("h3", 'Show' + (state.showSection.length === 1 ? '' : ' ' + (index + 1))));
	              __jade_nodes.push(h("div", {
	                "className": ['control-container'].filter(Boolean).join(' ')
	              }, views.editControl(util.extend(state, {
	                index: index
	              }))));
	              __jade_nodes.push(index === state.showSection.length - 1 ? h("div", {
	                "className": ['control-container'].filter(Boolean).join(' ')
	  ...
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "className" in locals ? locals.className : typeof className !== "undefined" ? className : undefined, "state" in locals ? locals.state : typeof state !== "undefined" ? state : undefined, "util" in locals ? locals.util : typeof util !== "undefined" ? util : undefined, "views" in locals ? locals.views : typeof views !== "undefined" ? views : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function (Boolean, className, constants, helpers, state, util) {
	    var h = __webpack_require__(347);
	    var selectedMathIndex = state.editing && constants.mathChoices.indexOf(state.editing.math);
	    var selectedTypeIndex = state.editing && constants.resourceTypeChoices.indexOf(state.editing.type);
	    var selectedValueIndex = state.editing && state.events.indexOf(state.editing.value);
	    return {
	      value: h("div", {
	        "className": [className].filter(Boolean).join(' ')
	      }, [[h("ul", {
	        "className": ['column', 'math'].filter(Boolean).join(' ')
	      }, [constants.mathChoices.map(function (math, i) {
	        return h("li", {
	          "className": [selectedMathIndex === i ? 'selected' : ''].filter(Boolean).join(' '),
	          "ev-click": function evClick() {
	            return helpers.updateSection(state.index, {
	              math: math
	            });
	          }
	        }, util.capitalize(math));
	      })]), h("ul", {
	        "className": ['column', 'resourceType'].filter(Boolean).join(' ')
	      }, [constants.resourceTypeChoices.map(function (type, i) {
	        return h("li", {
	          "className": [selectedTypeIndex === i ? 'selected' : ''].filter(Boolean).join(' '),
	          "ev-click": function evClick() {
	            return helpers.updateSection(state.index, {
	              type: type
	            });
	        ...
	        "className": ['column', 'resourceValue'].filter(Boolean).join(' ')
	      }, [state.events.map(function (value, i) {
	        return function () {
	          var __jade_nodes = [];
	          __jade_nodes.push(helpers.matchesSearch(util.renameEvent(value)) ? h("li", {
	            "className": [selectedValueIndex === i ? 'selected' : ''].filter(Boolean).join(' '),
	            "ev-click": function evClick() {
	              return helpers.updateSection(state.index, {
	                value: value
	              });
	            }
	          }, util.renameEvent(value)) : undefined);;
	          return __jade_nodes;
	        }.call(this);
	      })])]])
	    };
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "className" in locals ? locals.className : typeof className !== "undefined" ? className : undefined, "constants" in locals ? locals.constants : typeof constants !== "undefined" ? constants : undefined, "helpers" in locals ? locals.helpers : typeof helpers !== "undefined" ? helpers : undefined, "state" in locals ? locals.state : typeof state !== "undefined" ? state : undefined, "util" in locals ? locals.util : typeof util !== "undefined" ? util : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _datePicker = __webpack_require__(389);

	var _time = __webpack_require__(390);

	var _time2 = _interopRequireDefault(_time);

	var _timePaneContent = __webpack_require__(391);
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(TimePaneContentView.prototype), 'templateHelpers', this), {
	        updateSection: function updateSection(data) {
	          return _this2.app.updateSection(_constants.SECTION_TIME, 0, data);
	        },
	        rangeToString: function rangeToString() {
	          return JSON.stringify(_this2.app.clauseAt(_constants.SECTION_TIME, 0).range);
	        }
	      });
	    }
	  }]);
	...
	var TimeEditControlView = function (_EditControlView) {
	  ...
	  _createClass(TimeEditControlView, [{
	    key: 'section',
	    get: function get() {
	      return _constants.SECTION_TIME;
	    }
	  }, {
	    key: 'templateConstants',
	    get: function get() {
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(TimeEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel() {
	          var _app$clauseAt = _this5.app.clauseAt(_constants.SECTION_TIME, 0);

	          var unit = _app$clauseAt.unit;
	          var range = _app$clauseAt.range;
	          var from = range.from;
	          var to = range.to;

	          var now = new Date();
	          var startOfToday = new Date().setHours(0, 0, 0, 0);
	          var hoursFromNow = Math.round(Math.abs(now - from) / (60 * 60 * 1000));

	          if (hoursFromNow < 100) {
	            return 'last ' + hoursFromNow + ' hours';
	          }

	          var includeYear = from.getFullYear() !== to.getFullYear() || from.getFullYear() !== now.getFullYear();

	          var formatDate = function formatDate(date) {
	            return date.getMonth() + 1 + '/' + date.getDate() + (includeYear ? '/' + date.getFullYear().toString().slice(2) : '');
	          };
	  ...
	  var result_of_with = function (Boolean, className, state, util, views) {
	    ...
	    return {
	      value: h("div", {
	        ...
	        var __jade_nodes = [];
	        __jade_nodes.push(state.timeSection.length ? [h("div", {
	          "className": ['preposition'].filter(Boolean).join(' ')
	        }, ["in the"]), h("div", {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function (Boolean, className, helpers) {
	    var h = __webpack_require__(347);
	    return {
	      value: h("div", {
	        "className": [className].filter(Boolean).join(' ')
	      }, [h("irb-date-picker", {
	        "value": helpers.rangeToString(),
	        "ev-change": function evChange(event) {
	          return helpers.updateSection({
	            range: event.target.value
	          });
	        }
	      })])
	    };
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "className" in locals ? locals.className : typeof className !== "undefined" ? className : undefined, "helpers" in locals ? locals.helpers : typeof helpers !== "undefined" ? helpers : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _group = __webpack_require__(399);

	var _group2 = _interopRequireDefault(_group);

	var _groupPaneContent = __webpack_require__(400);

	var _groupPaneContent2 = _interopRequireDefault(_groupPaneContent);
	...
	var GroupPaneContentView = function (_PaneContentView) {
	  ...
	  _createClass(GroupPaneContentView, [{
	    key: 'TEMPLATE',
	    get: function get() {
	      return _groupPaneContent2.default;
	    }
	  }, {
	    key: 'templateConstants',
	    get: function get() {
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(GroupPaneContentView.prototype), 'templateHelpers', this), {
	        updateSection: function updateSection(index, data) {
	          return _this2.app.updateSection(_constants.SECTION_GROUP, index, data);
	        }
	      });
	    }
	  }]);
	...
	var GroupPaneView = function (_PaneView) {
	  ...
	  _createClass(GroupPaneView, [{
	    ...
	    get: function get() {
	      ...
	      return {
	        updateSearch: function updateSearch(index, search) {
	          return _this4.app.updateSection(_constants.SECTION_GROUP, index, { search: search });
	        }
	      };
	    }
	  }]);
	...
	var GroupAddControlView = function (_AddControlView) {
	  ...
	  _createClass(GroupAddControlView, [{
	    key: 'section',
	    get: function get() {
	      return _constants.SECTION_GROUP;
	    }
	  }, {
	    key: 'VIEWS',
	    get: function get() {
	  ...
	  _createClass(GroupEditControlView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(GroupEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel(index) {
	          return (0, _util.renameProperty)(_this7.app.clauseAt(_constants.SECTION_GROUP, index).value);
	        }
	      });
	    }
	  }]);
	    ...
	    get: function get() {
	      ...
	      return {
	        isDisabled: function isDisabled() {
	          var showValues = _this9.app.state[_constants.SECTION_SHOW].map(function (clause) {
	            return clause.value;
	          });
	          return showValues.length > 1 || showValues.indexOf(_constants.RESOURCE_VALUE_TOP_EVENTS) !== -1;
	        }
	      };
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function (Boolean, className, helpers, state, util, views) {
	    var h = __webpack_require__(347);
	    return {
	      value: h("div", {
	        "className": ['section', className, helpers.isDisabled() ? 'disabled' : ''].filter(Boolean).join(' ')
	      }, [function () {
	        var __jade_nodes = [];
	        __jade_nodes.push(!state.groupSection.length ? h("div", {
	          "className": ['clause', 'group'].filter(Boolean).join(' ')
	        }, [h("h3"), h("div", {
	          "className": ['control-container'].filter(Boolean).join(' ')
	        }, views.addControl(state))]) : state.groupSection.map(function (group, index) {
	          return [h("div", {
	            "className": ['preposition'].filter(Boolean).join(' ')
	          }, index ? 'and by' : 'by'), h("div", {
	            "className": ['clause', 'group'].filter(Boolean).join(' ')
	          }, [function () {
	            var __jade_nodes = [];
	            __jade_nodes.push(h("h3", 'Group' + (state.groupSection.length === 1 ? '' : ' ' + (index + 1))));
	            __jade_nodes.push(h("div", {
	              "className": ['control-container'].filter(Boolean).join(' ')
	            }, views.editControl(util.extend(state, {
	              index: index
	            }))));
	            __jade_nodes.push(state.groupSection.length < 2 && index == state.groupSection.length - 1 ? h("div", {
	              "className": ['control-container'].filter(Boolean).join(' ')
	            }, views.addControl(state)) : undefined);;
	            return __jade_nodes;
	          }.call(this)])];
	  ...
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "className" in locals ? locals.className : typeof className !== "undefined" ? className : undefined, "helpers" in locals ? locals.helpers : typeof helpers !== "undefined" ? helpers : undefined, "state" in locals ? locals.state : typeof state !== "undefined" ? state : undefined, "util" in locals ? locals.util : typeof util !== "undefined" ? util : undefined, "views" in locals ? locals.views : typeof views !== "undefined" ? views : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = function (Boolean, className, constants, helpers, state, util) {
	    var h = __webpack_require__(347);
	    var selectedTypeIndex = state.editing && constants.resourceTypeChoices.indexOf(state.editing.type);
	    var selectedValueIndex = state.editing && state.properties.indexOf(state.editing.value);
	    return {
	      value: h("div", {
	        "className": [className].filter(Boolean).join(' ')
	      }, [[h("ul", {
	        ...
	        "className": ['column', 'resourceValue'].filter(Boolean).join(' ')
	      }, [state.properties.map(function (value, i) {
	        return function () {
	          var __jade_nodes = [];
	          __jade_nodes.push(helpers.matchesSearch(util.renameProperty(value)) ? h("li", {
	            "className": [selectedValueIndex === i ? 'selected' : ''].filter(Boolean).join(' '),
	            "ev-click": function evClick() {
	              return helpers.updateSection(state.index, {
	                value: value
	          ...
	          }, util.renameProperty(value)) : undefined);;
	          return __jade_nodes;
	        }.call(this);
	      })])]])
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _filterPaneContent = __webpack_require__(407);

	var _filterPaneContent2 = _interopRequireDefault(_filterPaneContent);
	...
	var FilterPaneContentView = function (_PaneContentView) {
	  _inherits(FilterPaneContentView, _PaneContentView);

	  function FilterPaneContentView() {
	    _classCallCheck(this, FilterPaneContentView);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(FilterPaneContentView).apply(this, arguments));
	  }

	  _createClass(FilterPaneContentView, [{
	    key: 'TEMPLATE',
	    get: function get() {
	      return _filterPaneContent2.default;
	    }
	  }, {
	    key: 'templateConstants',
	    get: function get() {
	      return extend(_get(Object.getPrototypeOf(FilterPaneContentView.prototype), 'templateConstants', this), {
	    ...
	    get: function get() {
	      ...
	      return extend(_get(Object.getPrototypeOf(FilterPaneContentView.prototype), 'templateHelpers', this), {
	        updateSection: function updateSection(index, data) {
	          return _this2.app.updateSection(SECTION_FILTER, index, data);
	        }
	      });
	    }
	  }]);

	  return FilterPaneContentView;
	}(PaneContentView);
	...
	var FilterPaneView = function (_PaneView) {
	  ...
	  _createClass(FilterPaneView, [{
	    key: 'templateConstants',
	    get: function get() {
	      return extend(_get(Object.getPrototypeOf(FilterPaneView.prototype), 'templateConstants', this), {
	        header: 'Properties'
	      });
	    }
	  }, {
	    ...
	    get: function get() {
	      ...
	      return {
	        updateSearch: function updateSearch(index, search) {
	          return _this4.app.updateSection(SECTION_FILTER, index, { search: search });
	        }
	      };
	    }
	  }]);
	...
	var FilterAddControlView = function (_AddControlView) {
	  ...
	  _createClass(FilterAddControlView, [{
	    key: 'templateConstants',
	    get: function get() {
	      return extend(_get(Object.getPrototypeOf(FilterAddControlView.prototype), 'templateConstants', this), {
	        class: 'verb',
	        label: 'Filter'
	      });
	    }
	    ...
	    get: function get() {
	      ...
	      return extend(_get(Object.getPrototypeOf(FilterAddControlView.prototype), 'templateHelpers', this), {
	        isPaneOpen: function isPaneOpen() {
	          return _this6.app.isAddingClause(SECTION_FILTER);
	        },
	        openPane: function openPane() {
	          return _this6.app.startAddingClause(SECTION_FILTER);
	        }
	      });
	    }
	  }]);
	...
	var FilterEditControlView = function (_EditControlView) {
	  ...
	  _createClass(FilterEditControlView, [{
	    key: 'templateConstants',
	    get: function get() {
	      return extend(_get(Object.getPrototypeOf(FilterEditControlView.prototype), 'templateConstants', this), {
	        class: 'noun'
	      });
	    }
	  }, {
	    ...
	    get: function get() {
	      ...
	      return extend(_get(Object.getPrototypeOf(FilterEditControlView.prototype), 'templateHelpers', this), {
	        isPaneOpen: function isPaneOpen(index) {
	          return _this8.app.isEditingClause(SECTION_FILTER, index);
	        },
	        openPane: function openPane(index) {
	          return _this8.app.startEditingClause(SECTION_FILTER, index);
	        },
	        getLabel: function getLabel(index) {
	          var filter = _this8.app.clauseAt(SECTION_FILTER, index);
	          return [filter.property, filter.value];
	        },
	        getLabelConnector: function getLabelConnector(index) {
	          return ' equals ';
	        }
	      });
	    }
	...
	var FilterView = function (_BaseView) {
	  ...
	  _createClass(FilterView, [{
	    ...
	    get: function get() {
	      return {
	        addControl: new _control.AddControlView(this),
	        editControl: new _control.EditControlView(this)
	      };
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function (Boolean) {
	    var h = __webpack_require__(347);
	    return {
	      value: h("div", {
	        "className": ['section', 'filter-view', 'disabled'].filter(Boolean).join(' ')
	      }, [h("div", {
	        "className": ['clause', 'filter'].filter(Boolean).join(' ')
	      }, [h("div", {
	        "className": ['filter-add-control-view', 'verb'].filter(Boolean).join(' ')
	      }, [h("button", {
	        "className": ['modify'].filter(Boolean).join(' ')
	      }, ["Filter"])])])])
	    };
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function (Boolean, className, state, views) {
	    var h = __webpack_require__(347);
	    return {
	      value: h("div", {
	        "className": [className].filter(Boolean).join(' ')
	  ...
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "className" in locals ? locals.className : typeof className !== "undefined" ? className : undefined, "state" in locals ? locals.state : typeof state !== "undefined" ? state : undefined, "views" in locals ? locals.views : typeof views !== "undefined" ? views : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chart = __webpack_require__(416);

	var _result = __webpack_require__(417);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function (Boolean, JSON, className, state) {
	    var h = __webpack_require__(347);
	    return {
	      value: h("div", {
	        "className": [className].filter(Boolean).join(' ')
	  ...
	  }.call(this, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "JSON" in locals ? locals.JSON : typeof JSON !== "undefined" ? JSON : undefined, "className" in locals ? locals.className : typeof className !== "undefined" ? className : undefined, "state" in locals ? locals.state : typeof state !== "undefined" ? state : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mixpanelBrowser = __webpack_require__(426);

	var _mixpanelBrowser2 = _interopRequireDefault(_mixpanelBrowser);

	var _rollbarBrowser = __webpack_require__(427);
	...
	_mixpanelBrowser2.default.init(("<IRB production Mixpanel project token>"), {
	  debug: ("production") === 'development',
	  persistence: 'localStorage'
	});

	var rollbar = _rollbarBrowser2.default.init({
	  accessToken: ("f1363513be0a42d1951b4f4e153996ec"),
	...
	exports.mixpanel = _mixpanelBrowser2.default;
