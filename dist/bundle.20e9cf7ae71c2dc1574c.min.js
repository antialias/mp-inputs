...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chartUtil = __webpack_require__(417);
	  ...
	  _createClass(_class2, [{
	    ...
	    value: function render() {
	      ...
	      var $headers = $(this.headers.map(function (header) {
	        return $('<div>').addClass('bar-chart-header').append($('<div>').addClass('text').html(header === '$events' ? 'Events' : util.renameProperty(header))).get(0);
	      }));
	          ...
	          return function () {
	            ...
	            __jade_nodes.push(cell ? function () {
	              ...
	              __jade_nodes.push(j + 1 < row.length ? function () {
	                var __jade_nodes = [];
	                var headerText = headers[j] === '$events' ? 'Events' : util.renameProperty(headers[j]);;
	                var getLabel = function getLabel(value) {
	                  return headers[j] === '$events' ? util.renameEvent(value) : util.renamePropertyValue(value);
	                };;
	  ...
	  _createClass(_class, [{
	    ...
	    value: function attributeChangedCallback() {
	      ...
	      if (headers.length <= 1) {
	        ...
	        columnHeaders = (0, _chartUtil.nestedObjectKeys)(series).sort();
	        ...
	        __jade_nodes.push(h("div", {
	          ...
	          return h("tr", [row.map(function (cell, i) {
	            return function () {
	              ...
	              __jade_nodes.push(cell ? function () {
	                var __jade_nodes = [];
	                var value = headers[i] === '$event' ? util.renameEvent(cell.value) : cell.value;;
	                __jade_nodes.push(h("td", {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function ($component, Boolean, JSON, chartType, result, sections, util) {
	    var h = __webpack_require__(361);
	    return {
	      value: h("div", {
	        ...
	        __jade_nodes.push(h("div", {
	          ...
	          __jade_nodes.push(h("table-chart", {
	            "attributes": {
	              data: JSON.stringify(util.extend(result, {
