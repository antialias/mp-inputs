...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = (function(Boolean, className, constants, helpers, props, state, views) {
	    var h = __webpack_require__(346);
	    return {
	      value: h("div", {
	        ...
	        }, [(helpers.getLabelParts(props)).map(function(part, i) {
	          return (function() {
	            var __jade_nodes = [];
	            __jade_nodes.push(h("span", (part)));
	            __jade_nodes.push((i < helpers.getLabelParts(props).length - 1) ? (h("span", {
