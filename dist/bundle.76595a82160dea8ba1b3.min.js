...
/***/ function(module, exports, __webpack_require__) {
	...
	var _builderSections = __webpack_require__(405);

	var _builderSections2 = _interopRequireDefault(_builderSections);

	var _section = __webpack_require__(406);

	var _clause = __webpack_require__(372);

	var _topEvents = __webpack_require__(407);

	var _topEvents2 = _interopRequireDefault(_topEvents);

	var _topProperties = __webpack_require__(409);

	var _topProperties2 = _interopRequireDefault(_topProperties);

	var _topPropertyValues = __webpack_require__(410);

	var _topPropertyValues2 = _interopRequireDefault(_topPropertyValues);

	var _segmentation = __webpack_require__(411);

	var _segmentation2 = _interopRequireDefault(_segmentation);

	var _queryCache = __webpack_require__(412);
	  ...
	  _createClass(IRBApp, [{
	    ...
	    value: function updateClause(sectionType, clauseIndex, clauseData) {
	      ...
	      if (newClause.valid) {
	        ...
	        editingExistingClause && sectionType === 'filter' && newClause.filterTypeIsSetOrNotSet || newClause.value && !oldClause.filterValue && newClause.filterValue) {
	          newState.editingClause = null;
	        }

	        if ( // don't keep the pane open if we're adding a new non-filter clause
	        !editingExistingClause && sectionType !== 'filter') {
	          newState.editingClause = null;
	        }
	      }
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(ShowEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel(clauseIndex) {
	          ...
	          var value = clause.value === _clause.ShowClause.TOP_EVENTS ? 'Top ' + (0, _util.capitalize)(clause.resourceType) : clause.value;

	          return [math, ' of ', (0, _util.renameEvent)(value)];
	        }
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventsPropertiesClause = exports.EventsPropertiesClause = function (_Clause) {
	  ...
	  function EventsPropertiesClause() {
	    ...
	    _this.resourceType = attrs.resourceType || 'events';
	...
	var FilterClause = exports.FilterClause = function (_EventsPropertiesClau3) {
	  ...
	  function FilterClause() {
	    ...
	    _this4.filterType = attrs.filterType || 'equals';
	  ...
	  _createClass(FilterClause, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(FilterClause.prototype), 'attrs', this), { filterType: filterType, filterValue: filterValue });
	    }
	  }, {
	    key: 'valid',
	    get: function get() {
	      return _get(Object.getPrototypeOf(FilterClause.prototype), 'valid', this) && this.FILTER_TYPES.indexOf(this.filterType) !== -1;
	    }
	  }, {
	    key: 'filterTypeIsSetOrNotSet',
	    get: function get() {
	...
	FilterClause.FILTER_TYPES = FilterClause.prototype.FILTER_TYPES = ['equals', 'does not equal', 'contains', 'does not contain', 'is set', 'is not set'];
	  ...
	  _createClass(GroupEditControlView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(GroupEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel(clauseIndex) {
	          return (0, _util.renameProperty)(_this5.app.state.sections.getClause('group', clauseIndex).value);
	        }
	      });
	    }
	  }]);
	    ...
	    get: function get() {
	      ...
	      return {
	        isDisabled: function isDisabled() {
	          var showValues = _this7.app.state.sections.show.clauses.map(function (clause) {
	            return clause.value;
	          });
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(FilterPropertyPaneContentView.prototype), 'templateHelpers', this), {
	        selectProperty: function selectProperty(clauseIndex, value) {
	          _this2.templateHelpers.updateClause(clauseIndex, { value: value });
	          ...
	          window.requestAnimationFrame(function () {
	            return _this2.templateHelpers.updateClause(_this2.app.editingClauseIndex, { paneIndex: 1 });
	          });
	        }
	      });
	    }
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(FilterPropertyValuePaneContentView.prototype), 'templateHelpers', this), {
	        showPropertyValues: function showPropertyValues() {
	          return _this4.app.state.editingClause && !_this4.app.state.editingClause.filterTypeIsSetOrNotSet;
	        }
	      });
	    }
	  }]);
	  ...
	  _createClass(FilterEditControlView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(FilterEditControlView.prototype), 'templateHelpers', this), {
	        getLabel: function getLabel(clauseIndex) {
	          var clause = _this9.app.state.sections.getClause('filter', clauseIndex);
	          var property = (0, _util.renameProperty)(clause.value);
	          var connector = _this9.app.state.sections.getClause('filter', clauseIndex).filterType;
	          var propertyValue = clause.filterTypeIsSetOrNotSet ? '' : clause.filterValue;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = function (Boolean, constants, elementClass, helpers, state, util) {
	    var h = __webpack_require__(348);
	    var property = state.editingClause && state.editingClause.value;
	    var propertyValues = state.editingClause && state.topPropertyValues;
	    var selectedTypeIndex = state.editingClause && constants.filterTypeChoices.indexOf(state.editingClause.filterType);
	    var selectedValueIndex = state.editingClause && propertyValues.indexOf(state.editingClause.filterValue);
	    return {
	      value: h("div", {
	        "className": [elementClass].filter(Boolean).join(' ')
	      }, [[h("ul", {
	    ...
	    value: function buildParams(query) {
	      ...
	      if (filters.length) {
	        params.where = filters.map(function (filter) {
	          ...
	          if (property && (value || type === 'is set' || type === 'is not set')) {
