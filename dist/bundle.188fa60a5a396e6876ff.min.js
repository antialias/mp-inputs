...
/***/ function(module, exports, __webpack_require__) {
	...
	document.registerElement('show-add-control', function (_AddControl) {
	  ...
	  _createClass(_class2, [{
	    key: 'constants',
	    get: function get() {
	      return (0, _util.extend)(_get(Object.getPrototypeOf(_class2.prototype), 'constants', this), {
	        label: 'Compare'
	      });
	    }
	  }, {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(_class3.prototype), 'config', this), {
	        helpers: (0, _util.extend)(_get(Object.getPrototypeOf(_class3.prototype), 'config', this).helpers, {
	          getLabel: function getLabel() {
	            var clause = _this4.state.sections.getClause('show', _this4.clauseIndex);
	...
	var AddControl = exports.AddControl = function (_ControlComponent) {
	  ...
	  _createClass(AddControl, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(AddControl.prototype), 'config', this), {
	        helpers: (0, _util.extend)(_get(Object.getPrototypeOf(AddControl.prototype), 'config', this).helpers, {
	    ...
	    key: 'constants',
	    get: function get() {
	      return (0, _util.extend)(_get(Object.getPrototypeOf(AddControl.prototype), 'constants', this), {
	        class: 'verb',
	        showRemove: false
	      });
	    }
	...
	var EditControl = exports.EditControl = function (_ControlComponent2) {
	  ...
	  _createClass(EditControl, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(EditControl.prototype), 'config', this), {
	        helpers: (0, _util.extend)(_get(Object.getPrototypeOf(EditControl.prototype), 'config', this).helpers, {
	          removeClause: function removeClause() {
	            return _this6.app.removeClause(_this6.section, _this6.clauseIndex);
	          },
	          isPaneOpen: function isPaneOpen() {
	            return _this6.app.isEditingClause(_this6.section, _this6.clauseIndex);
	          }
	        })
	      });
	    }
	    ...
	    key: 'constants',
	    get: function get() {
	      return (0, _util.extend)(_get(Object.getPrototypeOf(EditControl.prototype), 'constants', this), {
	        class: 'noun',
	        showRemove: true
	      });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = function ($component, $helpers, Boolean) {
	    ...
	    return {
	      value: h("div", {
	        "className": ['irb-control', $component.constants.class || $helpers.getClass()].filter(Boolean).join(' ')
	      }, [function () {
	        var __jade_nodes = [];
	        __jade_nodes.push(h("button", {
	          ...
	          var __jade_nodes = [];
	          var label = $component.constants.label || $helpers.getLabel();
	        ...
	        __jade_nodes.push($component.constants.showRemove ? h("button", {
	          "className": ['remove'].filter(Boolean).join(' '),
	          "onclick": $helpers.removeClause
	        }) : undefined);
	        __jade_nodes.push($helpers.isPaneOpen() ? h("div", {
	      ...
	      return {
	        ...
	        helpers: {
	          isDisabled: function isDisabled() {
	            var showValues = _this2.state.sections.show.clauses.map(function (clause) {
	              return clause.value;
	            });
	  ...
	  _createClass(_class3, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(_class3.prototype), 'config', this), {
	        helpers: (0, _util.extend)(_get(Object.getPrototypeOf(_class3.prototype), 'config', this).helpers, {
	          getLabel: function getLabel() {
	            return (0, _util.renameProperty)(_this5.state.sections.getClause('group', _this5.clauseIndex).value);
	          }
	        })
	      });
	    }
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(_class5.prototype), 'config', this), {
	        ...
	        helpers: (0, _util.extend)(_get(Object.getPrototypeOf(_class5.prototype), 'config', this).helpers, {
	          selectProperty: function selectProperty(property, closePane) {
	            return _this8.config.helpers.updateStageClause({ value: property.name }, closePane);
	          }
	        })
	      });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = function ($component, $helpers, Boolean, sections) {
	    ...
	    return {
	      value: h("div", {
	        "className": ['section', 'builder-group', $helpers.isDisabled() ? 'disabled' : ''].filter(Boolean).join(' ')
	      }, [function () {
	        var __jade_nodes = [];
	        __jade_nodes.push(!sections.group.clauses.length ? h("div", {
	          ...
	          return [h("div", {
	            ...
	            __jade_nodes.push(sections.group.clauses.length < 2 && clauseIndex == sections.group.clauses.length - 1 ? h("div", {
	              "className": ['control-container'].filter(Boolean).join(' ')
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(_class2.prototype), 'config', this), {
	        helpers: (0, _util.extend)(_get(Object.getPrototypeOf(_class2.prototype), 'config', this).helpers, {
	          getLabel: function getLabel() {
	            var clause = _this3.state.sections.time.clauses[0];
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(_class4.prototype), 'config', this), {
	        ...
	        helpers: (0, _util.extend)(_get(Object.getPrototypeOf(_class4.prototype), 'config', this).helpers, {
	          updateStageClause: function updateStageClause(clauseData) {
	            _this6.app.updateStageClause(clauseData);
	  ...
	  _createClass(_class3, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(_class3.prototype), 'config', this), {
	        helpers: (0, _util.extend)(_get(Object.getPrototypeOf(_class3.prototype), 'config', this).helpers, {
	          getLabel: function getLabel() {
	            var clause = _this5.state.sections.getClause('filter', _this5.clauseIndex);
	      ...
	      return [{
	        ...
	        helpers: {
	          commitHandler: function commitHandler() {
	            return _this7.app.commitStageClause();
	          },
	          getHeader: function getHeader() {
	            var clause = _this7.state.stageClause;
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(_class5.prototype), 'config', this), {
	        ...
	        helpers: (0, _util.extend)(_get(Object.getPrototypeOf(_class5.prototype), 'config', this).helpers, {
	          selectProperty: function selectProperty(property) {
	            _this9.config.helpers.updateStageClause({
	              value: property.name,
	            ...
	            window.requestAnimationFrame(function () {
	              return _get(Object.getPrototypeOf(_class5.prototype), 'config', _this9).helpers.updateStageClause({ paneIndex: 1 });
	            });
	          }
	        })
	      });
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(_class6.prototype), 'config', this), {
	        ...
	        helpers: (0, _util.extend)(_get(Object.getPrototypeOf(_class6.prototype), 'config', this).helpers, {
	          updateStageClause: function updateStageClause(clauseData) {
	            return _this11.app.updateStageClause(clauseData);
	          },
	          showPropertyValues: function showPropertyValues() {
	            return _this11.state.stageClause && !_this11.state.stageClause.filterOperatorIsSetOrNotSet;
	          },
	          getValueMatches: function getValueMatches(string, invert) {
	            return _this11.state.topPropertyValues.filter(function (value) {
	          ...
	          toggleStringEqualsValueSelected: function toggleStringEqualsValueSelected(value) {
	            var selected = _this11.state.stageClause.filterValue || [];
	            ...
	            _this11.app.updateStageClause({ filterValue: filterValue });
	          },
	          getDoneLabel: function getDoneLabel() {
	            return _this11.app.isAddingClause() ? 'Add' : 'Update';
	          },
	          stopEditingClause: function stopEditingClause() {
	            return _this11.app.stopEditingClause();
	          }
	        })
	      });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _util2 = __webpack_require__(347);
	      ...
	      return {
	        ...
	        helpers: {
	          formatChartData: function formatChartData() {
	            ...
	            var data = JSON.parse(JSON.stringify(_this2.state.result.data)); // deep copy

	            function sumDateResults(obj) {
	              if ((0, _util.containsObjects)(obj)) {
	                Object.keys(obj).forEach(function (key) {
	                  var subObj = obj[key];
	                  var subKeys = Object.keys(subObj);

	                  if (subKeys.length) {
	                    if ((0, _util2.isDateString)(subKeys[0])) {
	            ...
	            function getRows(data) {
	              ...
	              if ((0, _util.containsObjects)(data)) {
	            ...
	            rows = (0, _util.transpose)((0, _util.transpose)(rows).map(function (row) {
	              return row.map(function (cell, i) {
	                return i && row[i - 1] === row[i] ? null : {
	                  span: (0, _util.countRun)(row, i),
	                  value: cell
	                };
	              });
	            }));
	          ...
	          getTickDistance: _util.getTickDistance
	        }
	      };
	    }
	  }]);
	  ...
	  _createClass(_class, [{
	    ...
	    value: function render() {
	      ...
	      var $headers = $(headers.map(function (header) {
	        return $('<div>').addClass('bar-chart-header').append($('<div>').addClass('text').html((0, _util2.renameProperty)(header))).get(0);
	      }));
	      ...
	      var tick = 0;
	      var ticks = [];
	      var tickDistance = (0, _util.getTickDistance)(this._chartMax);
	      if (this._chartMax) {
	        do {
	          ticks.push(tick);
	          tick += tickDistance;
	      ...
	      var $ticks = $(ticks.map(function (tick) {
	        return $('<div>').addClass('bar-chart-tick').width(tickDistance / _this2._chartMax * 100 + '%').append($('<div>').addClass('text').html((0, _util2.abbreviateNumber)(tick))).get(0);
	      }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function ($helpers, Array, Boolean, JSON, Math, util) {
	    var h = __webpack_require__(361);

	    var _$helpers$formatChart = $helpers.formatChartData();

	    var headers = _$helpers$formatChart.headers;
	    var rows = _$helpers$formatChart.rows;
	    var chartMax = _$helpers$formatChart.chartMax;

	    var gridLineDistance = $helpers.getTickDistance(chartMax);
	          ...
	          return function () {
	            ...
	            __jade_nodes.push(cell ? function () {
	              ...
	              __jade_nodes.push(j + 1 < row.length ? h("td", {
	                ...
	                "rowSpan": cell.span || 1,
	                "style": {
	                  'min-width': util.getTextWidth(util.renameProperty(headers[j]), 'bold 14px Helvetica') + "px"
	                }
	              }, [function () {
	                var __jade_nodes = [];
	                __jade_nodes.push(Array.isArray(cell.value) ? h("ul", [cell.value.map(function (value, $index) {
	                  return function () {
	                    var __jade_nodes = [];
	                    __jade_nodes.push(!j && !headers.length ? h("li", {
	  ...
	  }.call(this, "$helpers" in locals ? locals.$helpers : typeof $helpers !== "undefined" ? $helpers : undefined, "Array" in locals ? locals.Array : typeof Array !== "undefined" ? Array : undefined, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "JSON" in locals ? locals.JSON : typeof JSON !== "undefined" ? JSON : undefined, "Math" in locals ? locals.Math : typeof Math !== "undefined" ? Math : undefined, "util" in locals ? locals.util : typeof util !== "undefined" ? util : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function (JSON, result) {
	    var h = __webpack_require__(361);
	    return {
	  ...
	  }.call(this, "JSON" in locals ? locals.JSON : typeof JSON !== "undefined" ? JSON : undefined, "result" in locals ? locals.result : typeof result !== "undefined" ? result : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = function (Boolean) {
	    ...
	    return {
	      value: h("div", {
	        "className": ['pivot-table'].filter(Boolean).join(' ')
	      })
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function ($component, Boolean, chartType, result) {
	    var h = __webpack_require__(361);
	    return {
	      value: h("div", {
	        ...
	        }, $component.child(chartType + '-chart')));
	  ...
	  }.call(this, "$component" in locals ? locals.$component : typeof $component !== "undefined" ? $component : undefined, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "chartType" in locals ? locals.chartType : typeof chartType !== "undefined" ? chartType : undefined, "result" in locals ? locals.result : typeof result !== "undefined" ? result : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
