	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(AddControlView.prototype), 'templateHelpers', this), {
	        isPaneOpen: function isPaneOpen() {
	          return _this7.app.isAddingClause(_constants.SECTION_SHOW);
	        },
	        openPane: function openPane() {
	          return _this7.app.startAddingClause(_constants.SECTION_SHOW);
	        }
	      });
	    }
	  }]);
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(EditControlView.prototype), 'templateHelpers', this), {
	        isPaneOpen: function isPaneOpen(index) {
	          return _this9.app.isEditingClause(_constants.SECTION_SHOW, index);
	        },
	        openPane: function openPane(index) {
	          return _this9.app.startEditingClause(_constants.SECTION_SHOW, index);
	        },
	        getLabel: function getLabel(index) {
	          var comparison = _this9.app.clauseAt(_constants.SECTION_SHOW, index);
	    ...
	    get: function get() {
	      ...
	      return {
	        getLabelParts: function getLabelParts(props) {
	          var label = _this2.templateConstants.label || _this2.templateHelpers.getLabel(props);
	  ...
	  var result_of_with = (function(Boolean, className, constants, helpers, state, views) {
	    ...
	    return {
	      value: h("div", {
	        ...
	        [h("button", {
	          "ev-click": () => helpers.openPane(state.index),
	        }, [(function() {
	          var __jade_nodes = [];
	          let labelParts = helpers.getLabelParts(state.index);
	    ...
	    return {
	      value: h("div", {
	        ...
	        __jade_nodes.push((constants.search) ? (h("div", {
	          ...
	          "type": 'text',
	          "ev-input": event => handlers.updateSearch(state.index, event.target.value),
	        })])) : undefined);
	      ...
	      value: h("div", {
	        ...
	        [h("ul", {
	          ...
	          return h("li", {
	            ...
	            "ev-click": () => helpers.updateSection(state.index, {
	              math
	            }),
	...
	var AddControlView = function (_GroupControlView) {
	  ...
	  _createClass(AddControlView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(AddControlView.prototype), 'templateHelpers', this), {
	        isPaneOpen: function isPaneOpen() {
	          return _this7.app.isAddingClause(_constants.SECTION_GROUP);
	        },
	        openPane: function openPane() {
	          return _this7.app.startAddingClause(_constants.SECTION_GROUP);
	        }
	      });
	    }
	  }]);
	...
	var EditControlView = function (_GroupControlView2) {
	  ...
	  _createClass(EditControlView, [{
	    ...
	    get: function get() {
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(EditControlView.prototype), 'templateHelpers', this), {
	        isPaneOpen: function isPaneOpen(index) {
	          return _this9.app.isEditingClause(_constants.SECTION_GROUP, index);
	        },
	        openPane: function openPane(index) {
	          return _this9.app.startEditingClause(_constants.SECTION_GROUP, index);
	        },
	        getLabel: function getLabel(index) {
	          return (0, _util.renameProperty)(_this9.app.clauseAt(_constants.SECTION_GROUP, index).value);
	        }
	      });
	    }
	  }]);
