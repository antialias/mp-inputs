...
/***/ function(module, exports, __webpack_require__) {
	...
	var STANDALONE = window.parent === window; /* global API_LOCAL */
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(_class6.prototype), 'config', this), {
	        ...
	        helpers: (0, _util.extend)(_get(Object.getPrototypeOf(_class6.prototype), 'config', this).helpers, {
	          ...
	          toggleStringEqualsValueSelected: function toggleStringEqualsValueSelected(value) {
	            var clause = _this10.state.stageClause;
	...
	document.registerElement('operator-dropdown', function (_Dropdown) {
	  ...
	  _createClass(_class7, [{
	    ...
	    value: function toggleOpen() {
	      var clause = this.state.stageClause;
	    ...
	    return {
	      value: h("div", {
	        ...
	        "", selectedType == 'string' ? selectedOperator == 'equals' || selectedOperator == 'does not equal' ? function () {
	          ...
	          return __jade_nodes;
	        }.call(this)]) : selectedType == 'datetime' ? selectedOperator == 'was between' || selectedOperator == 'was on' ? function () {
	          var __jade_nodes = [];
