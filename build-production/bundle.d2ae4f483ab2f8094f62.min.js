	...
	var SegmentationQuery = function (_BaseQuery) {
	  ...
	  _createClass(SegmentationQuery, [{
	    ...
	    value: function buildQuery(state) {
	      ...
	      var eventQueries = state.sections.show.clauses.map(function (clause) {
	        var ev = clause.value;
	        if (ev.custom) {
	          return ev;
	        } else {
	      ...
	      return { type: type, eventQueries: eventQueries, segments: segments, filters: filters, unit: unit, from: from, to: to };
	    }
	  }, {
	    key: 'buildUrl',
	    value: function buildUrl() {
	    ...
	    key: 'buildParams',
	    value: function buildParams(eventData) {
	      // base params
	      var scriptParams = {
	        dates: {
	      ...
	      if (eventData.custom) {
	        ...
	        scriptParams.events = [];
	        scriptParams.customEventName = _clause.ShowClause.ALL_EVENTS.name;
	      } else {
	        scriptParams.events = eventData.map(function (ev) {
	    ...
	    value: function runQueries() {
	      ...
	      return this.query.eventQueries.map(function (events) {
	        return window.MP.api.query(_this2.buildUrl(), _this2.buildParams(events), _this2.buildOptions());
	      });
	    }
	  }, {
	    key: 'executeQuery',
	    value: function executeQuery() {
	      return Promise.all(this.runQueries()).then(function (resultSets) {
	        return resultSets.reduce(function (acc, results) {
	    ...
	    value: function processResults(results) {
	      ...
	      var queriedEventNames = this.query.eventQueries.reduce(function (acc, eventData) {
	        var names = [];
	        if (eventData.custom) {
	          names.push(eventData.name);
	        } else if (eventData.length === 0) {
	          names.push(_clause.ShowClause.ALL_EVENTS.name);
	        } else {
	          names.push(eventData.map(function (ev) {
	            return ev.name;
	          }));
	        }
	      ...
	      if (queriedEventNames.length === 1 && this.query.segments.length) {
	        var evName = queriedEventNames[0];
	        if (evName in series) {
	      ...
	      return ce.alternatives.reduce(function (selectors, ev) {
	        ...
	        if (cidMatch) {
	          (function () {
	            ...
	            var nestedCE = _this3.customEvents.find(function (c) {
	              return c.id === cid;
	            });
	            if (!nestedCE) {
	              ...
	              var nestedSelectors = _this3.customEventToSelectors(nestedCE).map(function (nestedSelector) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _builderPane = __webpack_require__(377);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pane = __webpack_require__(378);
	...
	var _toggle = __webpack_require__(392);

	var _toggle2 = _interopRequireDefault(_toggle);

	var _propertyPaneContent = __webpack_require__(396);

	var _propertyPaneContent2 = _interopRequireDefault(_propertyPaneContent);

	var _propertyValuePaneContent = __webpack_require__(397);

	var _propertyValuePaneContent2 = _interopRequireDefault(_propertyValuePaneContent);

	var _showPaneContent = __webpack_require__(398);
	      ...
	      return (0, _util.extend)(_get(Object.getPrototypeOf(_class2.prototype), 'config', this), {
	        ...
	        helpers: (0, _util.extend)(_get(Object.getPrototypeOf(_class2.prototype), 'config', this).helpers, {
	          paneHandler: function paneHandler(property, shouldClosePane) {
	            ...
	            _this6.config.helpers.updateStageClause({ filterType: filterType, value: value }, shouldClosePane);
	            ...
	            if (!shouldClosePane) {
	              ...
	              _this6.app.updateStageClause({ value: value });
	              window.requestAnimationFrame(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function ($component, $helpers, Boolean, Object, topProperties, util) {
	    var h = __webpack_require__(365);
	  ...
	  }.call(this, "$component" in locals ? locals.$component : typeof $component !== "undefined" ? $component : undefined, "$helpers" in locals ? locals.$helpers : typeof $helpers !== "undefined" ? $helpers : undefined, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "Object" in locals ? locals.Object : typeof Object !== "undefined" ? Object : undefined, "topProperties" in locals ? locals.topProperties : typeof topProperties !== "undefined" ? topProperties : undefined, "util" in locals ? locals.util : typeof util !== "undefined" ? util : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  locals = locals || {};;;
	  var result_of_with = function ($component, $helpers, Boolean, Date, JSON, Number, Object, util) {
	    var h = __webpack_require__(365);
	  ...
	  }.call(this, "$component" in locals ? locals.$component : typeof $component !== "undefined" ? $component : undefined, "$helpers" in locals ? locals.$helpers : typeof $helpers !== "undefined" ? $helpers : undefined, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "Date" in locals ? locals.Date : typeof Date !== "undefined" ? Date : undefined, "JSON" in locals ? locals.JSON : typeof JSON !== "undefined" ? JSON : undefined, "Number" in locals ? locals.Number : typeof Number !== "undefined" ? Number : undefined, "Object" in locals ? locals.Object : typeof Object !== "undefined" ? Object : undefined, "util" in locals ? locals.util : typeof util !== "undefined" ? util : undefined);
	  if (result_of_with) return result_of_with.value;
	}
	module.exports = _jade_template_fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _timePaneContent = __webpack_require__(412);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _jade_template_fn(locals) {
	  ...
	  var result_of_with = function ($component, $helpers, Boolean, Object) {
	    ...
	    var selectedRange = $helpers.getActiveClauseProperty('range');
	    return {
	      value: h("div", {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chartUtil = __webpack_require__(423);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _showHideSeries = __webpack_require__(438);

	var _showHideSeries2 = _interopRequireDefault(_showHideSeries);

	var _showHideSeriesPaneContent = __webpack_require__(439);
